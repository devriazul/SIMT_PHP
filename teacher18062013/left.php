...
<?php 
																...
																$clat=mysql_query("SELECT id, name FROM `tbl_menucat` WHERE id in(select cid from tbl_menuscat) and status='Active' and section='Teacher' order by position ASC") or die(mysql_error());
