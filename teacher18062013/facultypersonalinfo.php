...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg'];  }?></font></p>
		<form name="MyForm" autocomplete="off" action="facultypersonalinfoedit.php" method="post">
          <div align="center">          <table width="91%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr bgcolor="#F4F4FF">
              <td height="20" bgcolor="#FFFFFF" class="style2"><div id="box-div"><img name="" src="../facultyphoto/<?php echo $row['img']; ?>" width="96" height="96" alt="" /></div></td>
              <td height="20" bgcolor="#FFFFFF"><span style="font-family: Arial; font-size: 16pt; font-weight:bold; color:#003399"><?php echo $row['name'];  ?></span></td>
