    ...
    this.value = this.value.replace(/[^0-9\.]/g,'');
		...
		$(document).ready(function(){
			...
			/*$(".add_categoryfm").click(function(){
				...
				$.nyroModalManual({
					url: 'addstudentsmarks.php?id='+categoryId +'&session='+session +'&examname='+examname +'&deptid='+deptid +'&courseid='+courseid +'&eyear='+eyear +'&semesterid='+semesterid,
				  ...
				  ?>
                       <tr bgcolor="<?php echo $bgcolor; ?>">
                         <td height="25" class="style4"><?php echo $stdr['id']; ?>
                             <input type="hidden" value="<?php echo $stdr['session']; ?>" name="session" id="session" /></td>
