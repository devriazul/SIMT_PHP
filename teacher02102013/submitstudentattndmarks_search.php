...
<form name="MyForm" id="frm" autocomplete="off"  method="post" >           
             ...
             <tr>
               <td width="47%" height="20" class="style2"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="stdtbl">
                 <?php
  				  ...
  				  $crs="SELECT * FROM tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and attendancemarks<>'0' and attendancemarksprac<>'0'";
  				  $crq=$myDb->select($crs);
				  ...
				  <tr bgcolor="#DFF4FF">
                   <td width="192" height="25" class="style15">Student ID </td>
                   <td width="355" height="25" class="style15"><div align="left">Student Name</div></td>
                   <td width="166" class="style15"><div align="center">Total Working Days </div></td>
                   <td width="105" class="style15"><div align="center">Attended Days </div></td>
                   <td width="109" height="25" class="style15"><div align="center">Marks (In %) </div></td>
                   <td width="106" class="style15"><div align="center">Obtained Marks</div></td>
				  </tr>
				  <?php
                 ...
                 <tr bgcolor="<?php echo $bgcolor; ?>">
                   ...
                   <td class="style4" align="center"><input name="tnd" type="text" class="numbersOnly" id="tnd<?php echo $count; ?>" value="<?php echo $_POST['twork']; ?>" style="width:90px; height:12px; text-align:center;" onKeyPress="return handleEnter(this, event);" maxlength="3" /></td>
				   <td class="style4" align="center"><input name="ad" type="text" class="numbersOnly" id="ad<?php echo $count; ?>" style="width:90px; height:12px; text-align:center;" onKeyPress="return handleEnter(this, event);" maxlength="3" /></td>
                   <td height="25" class="style4" align="center"><input name="mp" type="text" class="numbersOnly" id="mp<?php echo $count; ?>" style="width:90px; height:12px; text-align:center;" onKeyPress="return handleEnter(this, event);" maxlength="3" readonly="true" /></td>

                   <td class="style4" align="center"><input name="fmarks[]" type="text" class="numbersOnly" id="fmarks<?php echo $count; ?>" style="width:90px; height:12px; text-align:center; background-color:#F5F5F5; color:#333333;" onKeyPress="return handleEnter(this, event);" maxlength="3"  readonly="true"/></td>
                 </tr>
		<script language="javascript">
		$(function () {
		...
		$(document).ready(function(){
  		$('#mp<?php echo $count; ?>').focus(function(){
   	        if($('#bm<?php echo $count; ?>').val()==4)
			{
				if($('#mp<?php echo $count; ?>').val()>90){
					$('#fmarks<?php echo $count; ?>').val(4);
				}else if(($('#mp<?php echo $count; ?>').val()>=80)&& ($('#mp<?php echo $count; ?>').val()<=90)){
					$('#fmarks<?php echo $count; ?>').val(3);
				}else if(($('#mp<?php echo $count; ?>').val()>=70)&& ($('#mp<?php echo $count; ?>').val()<=79)){
					$('#fmarks<?php echo $count; ?>').val(2);
				}else if(($('#mp<?php echo $count; ?>').val()<70)){
					$('#fmarks<?php echo $count; ?>').val(0);
				}
			}  
			else if($('#bm<?php echo $count; ?>').val()==8)
			{
				if($('#mp<?php echo $count; ?>').val()>90){
			...
			else if($('#bm<?php echo $count; ?>').val()==10)
			{
				if($('#mp<?php echo $count; ?>').val()>90){
