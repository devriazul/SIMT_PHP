...
{ 
	...
	{
		//--------------Serach Previous Lid------------------//
		$chsid="SELECT max(lid) as lid, cast( ifnull( max( substr( lid, 2, 100) ) , 0 ) AS signed int ) mid, length( cast(ifnull( max( substr( lid, 2, 4) ) , 0 ) AS signed int )) idlength FROM `tbl_leaveapplication` WHERE storedstatus<>'D'";
...
<div class="transbox"><div id="bothead" style=" position:absolute;  background-color:#666666;   padding:10px; color:#FFFFFF; left:400px;float:right;width:700px; height:auto; display:none; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
  ...
  -----------------------------------------<br/><br/>
   ...
   <label>* Type remarks where you can mentioned who is responsible for those class during your leave period.</label><br/> 
        ...
        <table width="80%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <td height="32" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">
              <table width="90%" align="center"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
				...
				if($row['clstatus']==1)
				{
                    ...
                    <span style=" font:Arial; font-size:12px; font-weight:normal; font:Georgia, 'Times New Roman', Times, serif; font-style:italic;">Your Casual Leave left </span><span style="font-size:12px; color:#FF0000 "><?php echo $reaminigdays;?></span><span style="font-size:12px; font-weight:normal;"> days out of </span> <span style="font-size:12px; color:#FF0000 "><?php echo $rrow['dayscount'];?></span><span style="font-size:12px; font-weight:normal; "> days. </span>
                    <?php }else{  ?>
          ...
          <tr>
            <td width="47%" align="center" height="20" class="style2"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
                <tr bgcolor="#F3F3F3">
                  <td height="29" colspan="6" class="style2">General Information
                    <input type="text" id="lid" name="lid" style="width: 80px" value="<?php echo "L".$autoid;?>" /></td>
                </tr>
                <tr>
...
<span id="tblhead" style="padding:5px;">Clcik Add to new row <a href="javascript:new_link()" class="style17">Add New </a></span>
                    <div id="newlink" style="border-top:1px solid #CCCCCC;">
  <div class="feed">
  <table width="650" border="0" align="center" cellpadding="0" cellspacing="1" id="stdtbl">
    <tr bgcolor="#DDF0FB">
      <td width="196" height="30">Date<span class="stars">*</span></td>
      <td width="18" height="30">Time<span class="stars">*</span></td>
      <td width="315">Faculty Name <span class="stars">*</span></td>
      <td width="315">Description<span class="stars">*</span> </td>
      </tr>
    <tr>
      <td height="30" class="style2"><input name="pdate[]" id="pdate[]" style="width: 80px" type="text"  value="<?php echo date('Y-m-d');?>" class="style4" onkeypress="return handleEnter(this, event)" /></td>
      <td height="30" class="style2"><input name="ptime[]" id="ptime[]" style="width: 80px" type="text" class="style4" onkeypress="return handleEnter(this, event)" /></td>
      <td><select name="facultyid[]" id="facultyid[]" class="style4" onkeypress="return handleEnter(this, event)">
      ...
      <td><input name="desc[]" id="desc[]" type="text" class="style4" size="20" onkeypress="return handleEnter(this, event)" /></td>
      </tr>
  </table>
  </div>
                      </div>                    <p id="addnew"></p>                    <div id="newlinktpl" style="display:none; border-top:1px solid #999999;">
	  <div class="feed">
  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
    ...
    <tr>
      ...
      <td></td>
                    ...
                    <p>
                        <textarea name="remarks" cols="30"  id="remarks" style="font-family: Verdana; width:500px; font-size: 8pt; border: 1px solid #3399FF" ></textarea>
                    </p></td>
                  </tr>
                <tr>
