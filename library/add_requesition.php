...
$(document).ready(function(){
  $('#submit-btn').click(function(){  
    var reqid=$('#reqid').val()?$('#reqid').val():$('#searchid').val();
  		  $('#MyRes').load("reqid_wise_list.php?reqid="+reqid);
...
<script language="javascript">
  $(document).ready(function(){
	 ...
	 $('#submit').click(function(){
	   ...
	   if($('#reqid').val()==""){
	     alert("Requisition ID can not left empty");
		 $('#reqid').focus();
		 return false;
	   }
	   if($('#empid').val()==""){
	  ...
	  $('#price').focus(function(){
	   ...
	   $('#pid').keyup(function(){
	      ...
	      $.get('../inventory/pick_product.php?p='+p+"&prtype="+prtype,function(rec){
		    $('#showpick').show();
		    $('#showpick').html(rec);
		  });	   
	   ...
	   $('#empid').keyup(function(){
	      var p=$('#empid').val();
	      $.get('../inventory/pick_staff_requisition.php?p='+p,function(rec){
...
$().ready(function() {
	$("#searchid").autocomplete("../inventory/search_requisition.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<script language="javascript" type="text/javascript">
 $(document).ready(function(){
  $('a[name="addPr"]').click(function(e){
    e.preventDefault();
	$('#addPrForm').load("add_prodductPopUp.php").
	css({'position':'absolute','top':'200px','margin-left':'30px;','width':'550px','height':'300px',
	     'background-color':'#666666','box-shadow':'1px 1px 10px #333333'}).
	fadeTo("slow",0.9);
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblleft">
      ...
      <tr>
		...
		<div id="addPrForm" style="margin-left:30px; "></div>
...
<form name="sfrm" id="sfrm" method="post">
  ...
  <tr>
    <td colspan="3" style="border-bottom:1px solid #333333; background-color:#CCCCCC; height:30px;">Add Requesition <div id="req"><label>Requisition ID:</label><label><input type="text" id="reqid" name="reqid" onkeypress="return handleEnter(this, event)" value="" /><input type="button" id="greq" name="greq" class="button-class"  value="Generate Requisition ID" ></label></div> </td>
  </tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td><label>
      <input name="expdate" type="text" class="style4" id="expdate" value="<?php echo date("Y-m-d"); ?>" size="30" datepicker="true" datepicker_format="YYYY-MM-DD" maxlength="10" isdatepicker="true" onkeypress="return handleEnter(this, event)" />
    </label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><label>
      <input type="button" name="submit" id="submit" value="Submit" class="button-class" />
           ...
           <div id="showpick" style=" position:absolute;width:500px; height:500px; height:auto;top:330px;margin-left:400px;"></div>
