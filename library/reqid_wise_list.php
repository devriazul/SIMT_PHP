 ...
 $(document).ready(function(){
 	  $('#addu2').click(function(){
	    var reqid='<?php echo $reqid; ?>';
		    ...
		    var thePopup = window.open( '../inventory/printRequisition.php?reqid='+reqid,"Requisition Information","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
...
<?php 	   
		     //echo '<div align="left" style="margin-left:30px"><input type="button" id="addu2" name="addu2" value="Print View" style="color: #999999; font-size: 8pt; font-family: Verdana; border: 1px solid #C0C0C0; background-color: #D9F0FB"></div>';
			 $sdq="
