...
<?php 
	 ...
	 $sdq="Select id, code as HostelCode, name as HostelName, address as Address, noofseats as TotalSeats from  tbl_hostel where name LIKE '$searchid%' and storedstatus<>'D' order by id limit $start,$per_page";
...
<?php 
 /* --------------------------------------------- */
 $msg='';
$query_pag_num = "SELECT COUNT(*) AS count FROM tbl_hostel";
