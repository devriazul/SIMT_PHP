...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php echo $_GET['msg'];?></font></p>
	...
	font-size:14px;	">&nbsp;</td>
           ...
           <tr>
             ...
             <td><label>
               <input name="year" type="text" id="year<?php echo $count; ?>" size="15" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)" readonly="true" />
             </label></td>
             <td><label>
