...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input">
		   <form id="sfrm" method="post" autocomplete="off" action="Report/viewJournalReport.php" target="_blank">
		     <label>Search Form</label>
			 <label><input name="fdate" type="text" class="style4" id="DPC_fdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" style="text-align:left; width:150px;" /></label>
			 <label><input name="tdate" type="text" class="style4" id="DPC_tdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" style="text-align:left; width:150px;" /></label>
