...
if(!empty($stdid)&&!empty($fdate)&&!empty($tdate)){
	...
	//if(!empty($fdate)&&!empty($tdate)){
		$pdf->Cell(80);
		$pdf->Cell(30,10,"(Date Wise) From date1111:".$fdate." To date:".$tdate,0,0,'C');
		$pdf->Ln(5);
	//}
	...
	$pdf->AddPage();
		$pdf->Cell(80);
		$pdf->Cell(30,10,"Student Wise Book Report",0,0,'C');
		$pdf->Ln(5);
	...
	$pdf->AddPage();
		$pdf->Cell(80);
		$pdf->Cell(30,10,"CourseID Wise Book Report",0,0,'C');
		$pdf->Ln(5);
	...
	$pdf->AddPage();
		$pdf->Cell(80);
		$pdf->Cell(30,10,"Department Wise Book Report",0,0,'C');
		$pdf->Ln(5);
