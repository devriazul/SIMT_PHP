  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
		   ...
		   <form id="sfrm" method="post" autocomplete="off" action="">
		     <label>V ID</label>
			 <label><input type="text" id="searchid" name="searchid" style="width:70px;" /></label>
			 <label>Year</label>
			 <label><input type="text" id="year" name="year" style="width:150px;" value="<?php echo date("Y"); ?>" /></label>	
			 <label>Month</label>
			 <label><select name="month" id="month">
			 ...
			 <label><a href="add_jurnal.php"><input type="button" name="addbtn" id="submit-btn" value="Add New" /></a></label>
		   </form>
		   </div>
		</div>
		</div>
	...
	<tr><Td>
			...
			<div id="bothead" style=" position:absolute; background-color:#999999; padding:10px; color:#FFFFFF; left:400px;float:right;width:auto; height:auto; display:none; font-family:'Courier New', Courier, monospace; font-size:14px;">
			 VOUCHER TYPE:<br/>
            ----------------<br/><br/>
