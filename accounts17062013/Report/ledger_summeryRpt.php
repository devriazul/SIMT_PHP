...
<body>
  ...
  ?>
<div style="width:auto; position:absolute; left:200px; top: -67px; height: 409px;">
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" bgcolor="#0066FF"><span class="style30">Date</span></td>
    <td height="30" bgcolor="#0066FF">&nbsp;</td>
    <td height="30" bgcolor="#0066FF"><span class="style30">Particulars</span></td>
    <td height="30" bgcolor="#0066FF"><span class="style30">Vch Type </span></td>
    <td height="30" bgcolor="#0066FF"><span class="style30">Vch No </span></td>
    <td height="30" bgcolor="#0066FF"><span class="style30">Debit</span></td>
    <td height="30" bgcolor="#0066FF"><span class="style30">Credit</span></td>
  ...
  <?php 
  $adr=0;$acr=0;
		$ts1=mysql_query("select * from tbl_2ndjournal where accno='$getacc' and vdate between '$_POST[fdate]' and '$_POST[tdate]'") or die(mysql_error());
		while($tsf1=mysql_fetch_array($ts1)){
 
     $cq=mysql_query("select*from tbl_2ndjournal where  accno!='$tsf1[accno]' and vdate between '$_POST[fdate]' and '$_POST[tdate]' order by vouchertype") or die(mysql_error());
	 while($cqf=mysql_fetch_array($cq)){ 
	 if($tsf1['voucherid']==$cqf['voucherid']){
	 
  ?>
    <td height="30"><?php echo $cqf['vdate']; ?></td>
    <td height="30"><?php if($cqf['vouchertype']=="P"){ echo "Dr"; }else if($cqf['vouchertype']=="R"){ echo "Cr"; }else{ 
  ...
  <?php  } } ?>  
    ...
    <td height="30">&nbsp;</td>
    <td height="30">&nbsp;</td>
    <td height="30"><?php   if($opvalue<0){ echo (-($opvalue))+$adr; }else{ echo $opvalue+$adr; }  ?></td>
    <td height="30"><?php echo $acr; ?></td>
    <td height="30">&nbsp;</td>
    <td height="30">&nbsp;</td>
  </tr>
    <tr>
      ...
      <td height="30">&nbsp;</td>
      <td height="30">&nbsp;</td>
      <td height="30"><?php   if($opvalue<0){ echo (((-($opvalue))+$adr)-($acr)); }else{ echo (($opvalue+$adr)-($acr)); }  ?></td>
      <td height="30">&nbsp;</td>
      <td height="30">&nbsp;</td>
    </tr>
    <tr>
