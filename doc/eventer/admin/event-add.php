...
<?php
	...
	if(isset($_POST['Submit'])) {
		...
		$query = "INSERT INTO `eventer_events` (`start_date`, `end_date`, `start_time`, `end_time`, `title`, `description`, `venue`, `link`, `image`, `image_alignment`, `status`,`departmentid`,`session`,`semester`,`coursecode`,`dayname`,`facultyid`) VALUES ('$start_date', '$end_date', '$start_time', '$end_time', '$title', '$description', '$venue', '$link', '$image', '$image_alignment', '$status','$departmentid','$session','$semester','$coursecode','$day','$facultyid'); ";
	...
	<div id="content">
        ...
        <table border="0" class="rows">
            ...
            <tr>
              ...
              <td><div id="flist" style="display:none"></div>			  </td>
            </tr>
            <tr>
