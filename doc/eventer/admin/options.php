            ...
            <table border="0" class="rows">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="calendar_padding" id="calendar_padding" size="69" value="<?php echo $row['calendar_padding']; ?>" />                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="date_box_width" id="date_box_width" size="69" value="<?php echo $row['date_box_width']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Date Box Height</strong></td>
                    <td><label for="date_box_height"></label>
                        <input type="text" name="date_box_height" id="date_box_height" size="69" value="<?php echo $row['date_box_height']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Date Box Horizontal Space</strong></td>
                    <td><label for="date_box_horizontal_space"></label>
                        <input type="text" name="date_box_horizontal_space" id="date_box_horizontal_space" size="69" value="<?php echo $row['date_box_horizontal_space']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Date Box Vertical Space</strong></td>
                    <td><label for="date_box_vertical_space"></label>
                        <input type="text" name="date_box_vertical_space" id="date_box_vertical_space" size="69" value="<?php echo $row['date_box_vertical_space']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Date Box Corner Radius</strong></td>
                    <td><label for="date_box_corner_radius"></label>
                        <input type="text" name="date_box_corner_radius" id="date_box_corner_radius" size="69" value="<?php echo $row['date_box_corner_radius']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Date Box BG Color</strong></td>
                    <td><label for="date_box_bg_color"></label>
                        <input type="text" name="date_box_bg_color" id="date_box_bg_color" size="69" value="<?php echo $row['date_box_bg_color']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Today Date Box BG Color</strong></td>
                    <td><label for="today_date_box_bg_color"></label>
                        <input type="text" name="today_date_box_bg_color" id="today_date_box_bg_color" size="69" value="<?php echo $row['today_date_box_bg_color']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Empty Date Box Alpha</strong></td>
                    <td><label for="empty_date_box_alpha"></label>
                        <input type="text" name="empty_date_box_alpha" id="empty_date_box_alpha" size="69" value="<?php echo $row['empty_date_box_alpha']; ?>" />                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><label for="week_day_names_short"></label>
                        <input type="text" name="week_day_names_short" id="week_day_names_short" size="69" value="<?php echo $row['week_day_names_short']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Week Day Names Long</strong></td>
                    <td><label for="week_day_names_long"></label>
                        <input type="text" name="week_day_names_long" id="week_day_names_long" size="69" value="<?php echo $row['week_day_names_long']; ?>" />                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><label for="month_names_short"></label>
                        <input type="text" name="month_names_short" id="month_names_short" size="69" value="<?php echo $row['month_names_short']; ?>" />                    </td>
                </tr>
                <tr>
                    <td><strong>Month Names Long</strong></td>
                    <td><label for="month_names_long"></label>
                        <input type="text" name="month_names_long" id="month_names_long" size="69" value="<?php echo $row['month_names_long']; ?>" />                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><label for="repeat_events"></label>
                        <select name="repeat_events" id="repeat_events">
                            <option value="1" <?php if ($row['repeat_events'] == 1) { ?> selected="selected" <?php } ?>>Yes</option>
                            <option value="0" <?php if ($row['repeat_events'] == 0) { ?> selected="selected" <?php } ?>>No</option>
                        </select>                    </td>
                </tr>
                <?php ?><tr>
                    <td><strong>Time Zone</strong></td>
                    <td><label for="time_zone"></label>
                        <input type="text" name="time_zone" id="time_zone" size="69" value="<?php echo $row['time_zone']; ?>" />                    </td>
                </tr><?php ?>
                <tr>
                    <td>&nbsp;</td>
