...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" id="stdtbl">
				<form name="MyForm" id="MyForm" action="rptcourseassigntofaculty.php" autocomplete="off"  method="post" target="_blank" >


           <tr>
             <td width="14%" class="style15"><div align="right">Department :</div></td>
             <td width="15%">
                 <div align="left">
                   <label>
             ...
             <td width="15%" class="style15">Semester :</td>
             <td width="15%">
               <div align="left">
                 <select name="semester" id="semester" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
                     ...
                     <?php 
					$vsse="SELECT  id, name AS SemesterName FROM tbl_semester WHERE storedstatus<>'D'";
  					$rse=$myDb->select($vsse);
				  while($stdr=$myDb->get_row($rse,'MYSQL_ASSOC')){
				  ?>
                     <option value="<?php echo $stdr['id']; ?>"><?php echo $stdr['SemesterName']; ?></option>
                     <?php } ?>
                 </select>
               </div></td>
           </tr>
           <tr>
             ...
             <td><div align="left">
               <input name="year" type="text" id="year" size="15" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)" />
             </div></td>
           </tr>
           <tr>
             <td class="style15">&nbsp;</td>
