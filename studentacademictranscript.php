...
<form name="MyForm" action="rptstudentacademictranscript.php" id="MyForm" method="post" enctype="multipart/form-data"   onsubmit="Javascript:return checkValidity();"  target="_blank" >           
	
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           <tr>
             <td width="18%" class="style11"><div align="left">Semester :</div></td>
             <td width="23%"><select name="semester" id="select" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
             ...
             <td class="style11"><div align="left">Student Board Roll :</div></td>
             <td>               <input name="stdbr" type="hidden" id="stdbr" size="15" style="font-family: Verdana;  font-size: 8pt;padding:3px; border: 1px solid #3399FF"  onkeypress="return handleEnter(this, event)"  />
               <input name="stdid" type="text" id="stdid" size="15" style="font-family: Verdana;  font-size: 8pt;padding:3px; border: 1px solid #3399FF"  onkeypress="return handleEnter(this, event)" placeholder="Type Student Board Roll No"/></td>
           ...
           <tr>
             ...
             <td width="16%" class="style11"><div align="left"></div></td>
             <td width="27%"><input name="serialno" type="hidden" id="serialno" size="15" style="font-family: Verdana;  font-size: 8pt;padding:3px; border: 1px solid #3399FF"  onkeypress="return handleEnter(this, event)" /></td>
             <td width="16%"></td>
           </tr>
           <tr>
