...
{ 
  ...
  $vs="SELECT*FROM tbl_batch WHERE id='$id' and storedstatus<>'D'";
  $r=$myDb->select($vs);
...
<div id="top-search-div"> 
		...
		<br />
<form name="MyForm" action="batchinfo.php" method="post" onsubmit="xmlhttpPost('ed_batch.php?id=<?php echo $id; ?>', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">          <div align="center"><br />
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            ...
            <tr>
              ...
              <td width="68%" height="20"><input name="batchname" type="text" id="batchname" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $row['batchname']; ?>" /></td>
            </tr>
            ...
            <tr>
              ...
              <td height="20"><label>
				...
				<?php $dep1="SELECT id,name FROM tbl_department WHERE id='$row[depcode]' and storedstatus IN('I','U')";
				       $depq1=$myDb->select($dep1);
				       $depr1=$myDb->get_row($depq1,'MYSQL_ASSOC');
				?>	
				<option selected="selected" value="<?php echo $depr1['id']; ?>"><?php echo $depr1['name']; ?></option>
