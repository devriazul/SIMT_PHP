...
document.forms[0][0].focus();
		...
		<div id="bms"></div>
          ...
          <table width="500" border="0" cellspacing="0" cellpadding="0" class="global-form">
            <tr>
            ...
            <tr>
              <td width="153" class="style15">Self No :</td>
