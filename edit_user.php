...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if($_GET['t']==1){ ?><span style="color:#66CC66; font-weight:bold;"><?php echo $_GET['msg'];?></span><?php }else{ ?><span style="color:#FF0000; font-weight:bold;"><?php echo $_GET['msg'];?></span><?php } ?></font></p>
				<form name="MyForm" autocomplete="off" action="edit_user.php" method="post" onsubmit="xmlhttpPost('update_user.php?id=<?php echo $_GET['id']; ?>', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            ...
            <tr>
              ...
              <td width="68%" height="20"><label>
                <input name="userid1" type="text" id="userid1" onkeypress="return handleEnter(this, event)" value="<?php echo $edrow['userid']; ?>" readonly="true" />
              </label></td>
            </tr>
            <tr>
              <td height="20" class="style2"><div align="left">Name</div></td>
              <td><div align="center"><span class="style2">:</span></div></td>
              <td height="20"><input name="username" type="text" id="username" onkeypress="return handleEnter(this, event)" value="<?php echo $edrow['username']; ?>" readonly="true" /></td>
            </tr>
            <tr>
              <td height="20" class="style2"><div align="left">Email ID </div></td>
              <td><div align="center"><span class="style2">:</span></div></td>
              <td height="20"><label>
                <input name="emailid" type="text" id="emailid" onkeypress="return handleEnter(this, event)" value="<?php echo $edrow['emailid']; ?>" readonly="true" />
              </label></td>
            </tr>
            <tr>
