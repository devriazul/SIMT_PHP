...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		<div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" action="managedesignation1.php">
			 ...
			 <label><input type="text" id="searchid" name="searchid" placeholder="Search by designation name" /></label>
	 ...
	 $sdq="SELECT id, name , description 
FROM tbl_designation
WHERE name LIKE '%$searchid%' AND storedstatus<>'D' order by id";
	$sdep=$myDb->dump_query($sdq,'edit_designation.php','del_designation.php',$car['upd'],$car['delt']);
	?>
</td>
      </tr>
	        <tr>
