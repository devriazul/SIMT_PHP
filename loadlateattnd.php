...
$myDb->connectDefaultServer()
	...
	$data="Select COUNT(id) as td From tbl_attendance Where efid='$efid' and monthname= '$smonth' and yearname= '$syear' and astatus='Late Present' and instatus='Regular In'";
