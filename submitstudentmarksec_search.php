				   ...
				   <td width="47%" height="20" class="style2"><table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#B5C3DE" id="stdtbl">
					...
					<?php
					 ...
					 <tr bgcolor="<?php echo $bgcolor; ?>"><?php 
					  $std="SELECT distinct m.stdid, s.boardrollno, m.examname, m.session, m.deptid, m.courseid, m.year, m.semesterid, (c.cont_assess_t+c.f_exam_t+c.cont_assess_p+c.f_exam_p) as TotalMarks, (c.cont_assess_t+c.f_exam_t) as TTotalMarks, (c.cont_assess_p+c.f_exam_p) as PTotalMarks,
					  ...
					  $stdr=$myDb->get_row($stdq,'MYSQL_ASSOC'); ?>
						...
						<div align="center"><input type="hidden" value="<?php echo $stdr['TTotalMarks']; ?>" name="ttm" id="ttm<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<div align="center"><input type="hidden" value="<?php echo $stdr['PTotalMarks']; ?>" name="ptm" id="ptm<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						</div></td>
					   ...
					   <td class="style4" align="center"><a alt="<?php echo "Theory Final Exam"; ?>" class="add_categoryfm" id="<?php echo $stdr['stdid'];?>" ></a>
						...
						<input type="hidden"  name="mp" id="mp<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="thom" id="thom<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="prom" id="prom<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="thmp" id="thmp<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="prmp" id="prmp<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						</td>
					...
					$(function () {
						...
						$("#thom<?php echo $count; ?>").val(ct+qt+attnt+fex);
						$("#prom<?php echo $count; ?>").val(je+hw+jer+jev+attnp+bhv+jef+jerf+jevf);

						//Calculate GPS & Grade
						var THOM = parseInt($("#thom<?php echo $count; ?>").val());
						var PROM = parseInt($("#prom<?php echo $count; ?>").val());
						var TTM = parseInt($("#ttm<?php echo $count; ?>").val());
						var PTM = parseInt($("#ptm<?php echo $count; ?>").val());
						var TOM = parseInt($("#tom<?php echo $count; ?>").val());
						var TM = parseInt($("#tm<?php echo $count; ?>").val());
						
						$("#thmp<?php echo $count; ?>").val((THOM/TTM)*100);			
						$("#prmp<?php echo $count; ?>").val((PROM/PTM)*100);			
						
						
						if(($('#ttm<?php echo $count; ?>').val()>0) && ($('#ptm<?php echo $count; ?>').val()>0))
						{
							if(($('#thmp<?php echo $count; ?>').val()>=40) && ($('#prmp<?php echo $count; ?>').val()>=40))
							{
						...
						else if(($('#ttm<?php echo $count; ?>').val()>0) && ($('#ptm<?php echo $count; ?>').val()==0))
						{
							if($('#thmp<?php echo $count; ?>').val()>=40)
							{
				 ...
				 <tr>
				   <td height="32" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;"><table width="100%"  border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
					 ...
					 <tr bgcolor="#DFF4FF">
					   <td height="23"><strong>JEVF:</strong> Job Experiment Viva Final </td>
					   <td><strong>TF:</strong> Theory Final </td>
					   <td><strong>MID:</strong> Mid Term </td>
					   <td><strong>ASS:</strong> Assignment</td>
					   <td>&nbsp;</td>
					 </tr>
					 <tr bgcolor="#DFF4FF">
					   <td><strong>TOM:</strong> Total Obtained Marks</td>
				 ...
				 <tr>
				   <td width="47%" height="20" class="style2"><table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#B5C3DE" id="stdtbl">
					  ...
					  <tr bgcolor="#DFF4FF">
					   ...
					   <td width="41" class="style2"><div align="center">JEVF</div></td>
					   <td width="38" class="style2"><div align="center">TF</div></td>
					   <td width="38" class="style2"><div align="center">MID</div></td>
					   <td width="24" class="style2"><div align="center">ASS</div></td>
					   <td width="70" class="style2"><div align="center">TOM</div></td>
					   <td width="80" class="style2"><div align="center">Grade</div></td>
					  </tr>					
					<?php
					  ...
					  ?>
					 <tr bgcolor="<?php echo $bgcolor; ?>"><?php 
					  $std="SELECT distinct m.stdid, s.boardrollno, m.examname, m.session, m.deptid, m.courseid, m.year, m.semesterid, (c.cont_assess_t+c.f_exam_t+c.cont_assess_p+c.f_exam_p) as TotalMarks, c.cont_assess_t as TCMarks, c.f_exam_t as TFMarks, c.cont_assess_p as PCMarks, c.f_exam_p as PFMarks,
							(select classtestmarks from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]'  and stdid='$crsr[stdid]') as ClassTest,
							(select quiztestmarks from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as QuizTest ,
							(select `hwmarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as HomeWork,
							(select `jobexpr` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as JobExperiment,
							...
							(select `finalexamprac` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as FinalExamPrac,
							(select `finalexammarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as FinalExam,
							(select `midterm` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as MidTerm,
							(select `assignment` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$_GET[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$crsr[stdid]') as Assignment
					  ...
					  $stdr=$myDb->get_row($stdq,'MYSQL_ASSOC'); ?>
						...
						<td height="25" class="style4"><?php echo $stdr['stdid']." (".$stdr["boardrollno"].")";?><input type="hidden" value="<?php echo $stdr['stdid']; ?>" name="stdid[]" id="stdid" /><input type="hidden" value="<?php echo $stdr['session']; ?>" name="session" id="sessionnew" /><input type="hidden" value="<?php echo $stdr['deptid']; ?>" name="deptid" id="deptid" /><input type="hidden" value="<?php echo $stdr['courseid']; ?>" name="courseid" id="courseid" /><input type="hidden" value="<?php echo $stdr['year']; ?>" name="eyear" id="eyear" /><input type="hidden" value="<?php echo $stdr['semesterid']; ?>" name="semesterid" id="semesterid" /></td>
						<td height="25" class="style4" ><div align="center"><input type="label" value="<?php echo $stdr['TotalMarks']; ?>" name="tm" id="tm<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<div align="center"><input type="hidden" value="<?php echo $stdr['TCMarks']; ?>" name="tcmarks" id="tcmarks<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<div align="center"><input type="hidden" value="<?php echo $stdr['TFMarks']; ?>" name="tfmarks" id="tfmarks<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<div align="center"><input type="hidden" value="<?php echo $stdr['PCMarks']; ?>" name="pcmarks" id="pcmarks<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<div align="center"><input type="hidden" value="<?php echo $stdr['PFMarks']; ?>" name="pfmarks" id="pfmarks<?php echo $count; ?>" style="width:50px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						</div></td>
						...
						<td class="style4" align="center"><a alt="<?php echo "Mid Term"; ?>" class="add_categoryfm" id="<?php echo $stdr['stdid'];?>" ><span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; color:#FF0000; " ><input type="label" value="<?php echo $stdr['MidTerm']; ?>" name="mid" id="mid<?php echo $count; ?>" style="width:50px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled"/></span></a></td>
						<td class="style4" align="center"><a alt="<?php echo "Assigment"; ?>" class="add_categoryfm" id="<?php echo $stdr['stdid'];?>" ><span style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:10px; color:#FF0000; " ><input type="label" value="<?php echo $stdr['Assignment']; ?>" name="ass" id="ass<?php echo $count; ?>" style="width:50px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled"/></span></a></td>
						<td class="style4" align="center"><a alt="<?php echo "Theory Final Exam"; ?>" class="add_categoryfm" id="<?php echo $stdr['stdid'];?>" ></a>
						<input type="label"  name="tom" id="tom<?php echo $count; ?>" style="width:60px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="mp" id="mp<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
						<input type="hidden"  name="thom" id="thom<?php echo $count; ?>" style="width:60px; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" />
					...
					$(function () {
						...
						$("#tom<?php echo $count; ?>").val(ct+qt+je+hw+jer+jev+attnt+attnp+bhv+jef+jerf+jevf+fex+mid+ass);
						//$("#thom<?php echo $count; ?>").val(ct+qt+attnt+fex+mid+ass);
						// $("#prom<?php echo $count; ?>").val(je+hw+jer+jev+attnp+bhv+jef+jerf+jevf);
						var TC = ct+qt+attnt+mid+ass;
						var TF = fex;
						var PC = je+hw+jer+jev+bhv+attnp;
						var PF = jef+jerf+jevf;
						...
						// var TTM = parseInt($("#ttm<?php echo $count; ?>").val());
						// var PTM = parseInt($("#ptm<?php echo $count; ?>").val());
						var TCmarks = parseInt($("#tcmarks<?php echo $count; ?>").val());
						var TFmarks = parseInt($("#tfmarks<?php echo $count; ?>").val());
						var PCmarks = parseInt($("#pcmarks<?php echo $count; ?>").val());
						var PFmarks = parseInt($("#pfmarks<?php echo $count; ?>").val());
						...
						// $("#thmp<?php echo $count; ?>").val((THOM/TTM)*100);			
						// $("#prmp<?php echo $count; ?>").val((PROM/PTM)*100);	
						var OTC = (TC/TCmarks)*100;
						var OTF = (TF/TFmarks)*100;
						var OPC = (PC/PCmarks)*100;
						var OPF = (PF/PFmarks)*100;					
