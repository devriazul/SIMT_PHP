...
$().ready(function() {
	...
	$("#searchdid").autocomplete("search_department.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
 ...
 <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
                    ...
                    ({
                        type: "GET",
                        url: "marksdistribution_pagination.php",
                        data: "page="+page,
					  //  data:$("form").serialize(),
				...
				$('#searchid').keyup(function(){
				  ...
				  $.post("marksdistribution_pagination.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
				
				});  
				$('#searchdid').keyup(function(){
				  var arr=$('#frmsrch').serializeArray();
				  $.post("marksdistribution_pagination.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
...
<div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" id="frmsrch" name="frmsrch" action="#">
			 ...
			 <label><input type="text" id="searchdid" name="searchdid" placeholder="Search by dept name" /></label>
