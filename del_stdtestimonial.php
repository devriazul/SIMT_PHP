...
{ 
  ...
  if(($car['ins']=="y")||($_SESSION['userid']=="administrator")){
	...
	if(($htrow['psid']==$htrow['payscaleid'])&&($htrow['psid']!="")&&($htrow['payscaleid']!="")){
	   ...
	   $qup="Delete from tbl_stdtestimonial WHERE `id`='$id'";
	   $upd=$myDb->update_sql($qup);

		$query="INSERT INTO `tbl_logdetails` (`formname`, `tblname`, `tblid`, `opby`, `opdate`, `storedstatus`) VALUES ('Student Testimonial', 'tbl_stdtestimonial', '$id',  '$_SESSION[userid]','$opdate','I')";
