...
{ 
  ...
  include('productExistancy2.php');
  if($myDb->insert_sql("INSERT INTO tbl_product(pname,packsize,prtype,mname,opby,qty)VALUES('$pname','$packsize','$prtype','$prtype','$_SESSION[userid]','$qty')")){
