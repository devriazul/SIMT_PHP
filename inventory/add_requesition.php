...
<script language="javascript" type="text/javascript">
 $(document).ready(function(){
  $('a[name="addPr"]').click(function(e){
	...
	css({'position':'absolute','top':'200px','margin-left':'30px;','width':'550px','height':'250px',
...
<form name="sfrm" id="sfrm" method="post">
  ...
  <tr>
    ...
    <td>:</td>
    <td><label>
      <input type="text" name="estprice" id="estprice" onkeypress="return handleEnter(this, event)" >
    </label></td>
  </tr>
  <tr>
    <td>Expected Date</td>
    <td>:</td>
    <td><label>
<input type="date" name="expdate" id="expdate" size="30" value="<?php echo date("Y-m-d"); ?>" onkeypress="return handleEnter(this, event)" >      
    </label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
