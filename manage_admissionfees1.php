...
<?php 
 ...
 if(isset($_POST['stdid'])){	
	...
	ON f.stdid=s.stdid
    WHERE f.stdid like '%$_POST[stdid]%' and f.storedstatus<>'D' and s.storedstatus<>'D'	
	GROUP BY f.id,f.stdid,s.stdname,f.edate,f.frommonth,f.tomonth";
	
	
	$sdep=$myDb->dump_query($query,'edit_admissionfees.html','del_admissionfees.html',$car['upd'],$car['delt']);
 }	?>
          <p align="center">&nbsp;
            </p>
<p></p>
