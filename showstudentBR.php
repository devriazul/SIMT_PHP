		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="gridTblt">
				...
				<tr bgcolor="#F4F4FF">
					...
					<th width="22%" height="27" class="gridTblHead"><div align="left"><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:x-small; font-weight:bold; ">Board Roll</span></div></th>
					...
					<th width="17%" class="gridTblHead"><div align="left"><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:x-small; font-weight:bold; ">Session</span></div></th>
					<th width="17%" class="gridTblHead"><div align="left"><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:x-small; font-weight:bold; ">Batch</span></div></th>
				...
				<?php 
				$src=mysql_real_escape_string($_POST['searchidBR']);
				$uac=$myDb->select("SELECT s.*, d.name as department, b.batchname as BatchName 
									...
									on s.batch=b.id 
									WHERE boardrollno LIKE '$src%' order by id desc");
				...
				?>
					...
					<tr bgcolor="#FFFFFF">
						...
						<td height="21" class="gridTblValue"><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:x-small; "><?php echo $uacf['boardrollno']; ?></span></td>
						...
						<a class="remove" target="_blank" href="reportindvidualstudent.php?sid=<?php echo $uacf['stdid']; ?>"  name="modal"><span style="font:Verdana, Arial, Helvetica, sans-serif; font-size:x-small; ">Preview</span></a>
