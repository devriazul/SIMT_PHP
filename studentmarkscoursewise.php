...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	...
	$.post('studentmarkscoursewise_search.php?courseid='+courseid,arr,function(result){
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Subjectwise Student Marks</label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
				<form name="MyForm" id="MyForm" autocomplete="off"  method="post" action="rptstudentmarkscoursewise.php" target="_blank" >
           <tr>
             <td width="11%" class="style15">Department: </td>
             <td width="30%"><select name="deptid" id="deptid"  onkeypress="return handleEnter(this, event)">
             ...
             <td class="style15"><div align="right">Semester:</div></td>
             ...
             <td><input type="submit"  value="Print" style="color: #999999; font-size: 8pt; font-family: Verdana; border: 1px solid #C0C0C0; background-color: #D9F0FB" /></td>
           </tr>
           <tr>
             ...
             <td><select name="session" class="style2" id="session" style="font-family: Verdana; width:100px; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" >
               ...
               <input name="year" type="text" id="year" size="15" style="font-family: Verdana; width:30px; font-size: 8pt;padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)" /></td>
             <td width="9%" class="style15"><div align="right">Subject:</div></td>
             <td width="43%"><div id="Result" align="center"></div></td>
