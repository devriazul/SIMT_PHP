...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='studentsresulttc.php' AND userid='$_SESSION[userid]'";
...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	...
	$.post('studentsresulttc_search.php?courseid='+courseid,arr,function(result){
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label> Students Result Theory Contineous </label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
