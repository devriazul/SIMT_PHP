...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Course Assign to Faculty Report</label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
	...
	<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" id="stdtbl">
				<form name="MyForm" id="MyForm" action="rptcourseassigntofacultybyname.php" autocomplete="off"  method="post" target="_blank" >


           <tr>
             <td width="14%" class="style15"><div align="right">Faculty Name  :</div></td>
             <td width="15%">
                 <div align="left">
                   <label>
                   <select name="faculty" id="select" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
                     <option value="-1" selected="selected">Select Faculty</option>
                     <?php 
					$vsse="SELECT  id, name AS FacultyName FROM tbl_faculty WHERE storedstatus<>'D'";
  					$rse=$myDb->select($vsse);
				  while($stdr=$myDb->get_row($rse,'MYSQL_ASSOC')){
				  ?>
                     <option value="<?php echo $stdr['id']; ?>"><?php echo $stdr['FacultyName']; ?></option>
                     <?php } ?>
                   </select>
</label>
                 </div></td>
           ...
           <tr>
             <td class="style15"><div align="right">Session : </div></td>
           ...
           <tr>
             <td class="style15"><div align="right">Year :</div></td>
             <td><input name="year" type="text" id="year2" size="15" style="font-family: Verdana; font-size: 8pt; width:60px; padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)" /></td>
             </tr>
           <tr>
             <td class="style15">&nbsp;</td>
             <td>&nbsp;</td>
