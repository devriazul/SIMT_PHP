        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
                    ...
                    ({
                        type: "GET",
                        url: "followers_list.php?searchid="+searchid,
                        data: "page="+page,
					  //  data:$("form").serialize(),
 ...
 $(document).ready(function(){
 	  $('input[name=addu2]').click(function(){
	    var searchid=$('#searchid').val();
		    ...
		    var thePopup = window.open( 'store_status_report.php?searchid='+searchid,"Stock Status","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
