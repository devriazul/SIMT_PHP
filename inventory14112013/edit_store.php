...
<table width="1047" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="30" colspan="3" style="background-color:#CCCCCC; border-bottom:1px solid #333333; ">Add Store </td>
  </tr>
  <tr>
    <td width="135">Store Code</td>
    <td width="6">:</td>
    <td width="259"><input type="hidden" id="id" name="id" value="<?php echo $id; ?>" /><label>
      <input type="text" name="storeid" id="storeid"  value="<?php echo $stf['storeid']; ?>"  onkeypress="return handleEnter(this, event)"/>
    </label></td>
  </tr>
  <tr>
    <td>Store Name</td>
