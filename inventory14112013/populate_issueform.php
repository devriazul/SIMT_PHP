...
<form name="sfrm" id="sfrm" method="post">
		  ...
		  <table width="700" border="0" cellspacing="0" cellpadding="0" class="form-table" style="padding:5px;">
  <tr>
    ...
    <tr>
      ...
      <td>Qty</td>
      <td>:</td>
      <td><input type="text" name="qty" id="qty" onkeypress="return handleEnter(this, event)" value="<?php echo $storef['name']; ?>" style="width:40px;" />
