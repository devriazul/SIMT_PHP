...
{ 
  ...
  if($car['ins']=="y"){
	  ...
	  $setref=$myDb->update_sql("TRUNCATE TABLE tbl_reffinal");
	  $setref=$myDb->update_sql("TRUNCATE TABLE tbl_reffinalforsummery");
	  $setref=$myDb->update_sql("TRUNCATE TABLE tbl_stdpassinfo");
