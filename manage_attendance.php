        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
				...
				$('input[name="subs"]').click(function(){
				  ...
				  $.post("attendance_pagination.php?page=1",arr,function(msg){
				     loading_hide();
                     $("#container").html(msg);
				  });
				});           
...
<div id="top-search-div"> 
		   ...
		   <form method="post" id="frmsrch" name="frmsrch" autocomplete="off" action="#">
             ...
             <table width="575" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td>Search Form : </td>
                 <td><input type="date" id="fdate" name="fdate" style="width:150px" value="<?php echo date('Y-m-d');?>" /></td>
                 <td><input type="date" id="tdate" name="tdate" style="width:150px" value="<?php echo date('Y-m-d');?>"/>                   </td>
                 <td><input type="button" name="subs" id="submit-btn" value="Search" /></td>
               </tr>
             </table>
             <label>             </label>
             <label></label>
