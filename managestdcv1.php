...
<div id="top-search-div"> 
		...
		<br />
          <?php  $sdq="SELECT id, stdid as StudID, stdname as Name, department as Department, session as Session, cgpa as CGPA, passingyear as PassingYear FROM tbl_stdcv  WHERE stdid ='$_POST[searchid]' and storedstatus <>'D' order by id desc  ";
			    $sdep=$myDb->dump_query($sdq,'edit_stdcv.php','del_stdcv.php',$car['upd'],$car['delt']);
				?>
          <p align="center">&nbsp;
</p>
<p></p>
