...
<?php 
	...
	$sdq="SELECT id, code AS Code, name AS Name, admissionfee AS AdFee, labfee AS LabFee, libraryfee AS LibFee, idcardfee AS IDCardFee, regifee AS RegiFee, onetimefee AS TotalFee, (noofsemester * semesterfee) AS TotalSemesterFee, (noofmonths * tuitionfee) AS TotalTuitionFee, credit AS Credit FROM tbl_department WHERE name LIKE '$searchid%' and storedstatus<>'D' order by id desc limit $start,$per_page";
...
<?php 
 /* --------------------------------------------- */
 $msg='';
$query_pag_num = "SELECT COUNT(*) AS count FROM tbl_department";
