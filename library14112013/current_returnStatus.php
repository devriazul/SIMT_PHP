      ...
      <tr>
        <td width="21%" valign="top" background="images/leftbg.jpg"><?php include("left.php");?><br />
		   ...
		   <form method="post" id="srs">
             <label>
			 <input type="text" id="deptsearch" name="deptsearch" placeholder="Search By Department" class="input_small">
			 </label>			 
             <label>From Date:<input type="date" name="fdate" id="fdate" size="30"  onkeypress="return handleEnter(this, event)" ></label>
			 <label>To Date:<input type="date" name="tdate" id="tdate" size="30"  onkeypress="return handleEnter(this, event)" min="<?php echo date("Y-m-d"); ?>"></label>
...
<div style="padding-left:50px;width:700px;" id="book-form"></div>
