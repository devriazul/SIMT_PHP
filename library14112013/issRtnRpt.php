...
<script language="javascript">
  $(document).ready(function(){
	 $('#submit-btn1').click(function(){
		var thePopup = window.open("reports/allTypeRtnRpt.php?name=<?php echo urlencode($_GET['name']); ?>","Book Issue & Return Information","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
			thePopup.print();
...
<script language="javascript">
  $(document).ready(function(){
	 $('#submit-btn1').click(function(){
		var thePopup = window.open("reports/allTypeRtnRpt.php?courseid=<?php echo urlencode($_GET['courseid']); ?>","Book Issue & Return Information","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
			thePopup.print();
	 ...
	 $('#submit-btn1').click(function(){
	  ...
	  <?php 		  
		...
		case "stdid":
		  ...
		  $Msql="SELECT stdid 'Student ID',stdname 'Student Name' FROM tbl_stdinfo WHERE {$prs->getFieldName()}='{$prs->getFieldValue()}'";
		  $prs->MainCategory($Msql);
...
<script language="javascript">
  $(document).ready(function(){
	 $('#submit-btn1').click(function(){
		var thePopup = window.open("reports/allTypeRtnRpt.php?stdid=<?php echo urlencode($_GET['stdid']); ?>","Book Issue & Return Information","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
			thePopup.print();
