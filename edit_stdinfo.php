...
<form name="MyForm" action="edstd.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" onsubmit="Javascript:return checkstd();">
          ...
          <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              <td height="26" colspan="6" class="style11" style="padding:3px; border-bottom:1px solid #CCCCCC">STUDENT INFORMATION|| ID:<?php echo $edr['stdid']; ?> </td>
              </tr>
            <tr>
              <td width="18%" height="26" align="right" class="style4">Name<span class="stars">*</span></td>
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4">Hostel<span class="stars">*</span></span></td>
              <td height="26">&nbsp;</td>
              <td height="26"><select name="hostel" class="style4" id="hostel" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
                <?php $htl=$myDb->select("select*from tbl_hostel where id in(select hostelid from tbl_stdinfo where id='$id')");
				$htlf=$myDb->get_row($htl,'MYSQL_ASSOC');
				?>
				<option selected value="<?php echo $htlf['code']; ?>"><?php echo $htlf['name']; ?></option>
            ...
            <tr>
              ...
              <td height="26" align="right" class="style4">Board Registration No</td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><input name="boardregno" type="text" class="style4" id="boardregno" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="40" value="<?php echo $edr['boardregno']; ?>"/></td>
            </tr>
            ...
            <tr>
              ...
              <td height="26"><span class="style4" >:</span></td>
              <td height="26" valign="top"><img src="uploads/<?php echo $edr['img']; ?>" width="80" height="80" />
            ...
            <tr>
              <td height="26">&nbsp;</td>
              <td height="26">&nbsp;</td>
              <td height="26" colspan="4" align="center"><input type="submit" value="Update" name="B1" style="color: #999999; font-size: 8pt; font-family: Verdana; border: 1px solid #C0C0C0; background-color: #D9F0FB" />                </td>
            </tr>
          </table>
            </form>
