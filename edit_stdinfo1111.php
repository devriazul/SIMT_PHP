...
<form name="MyForm" action="edstd.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" onsubmit="Javascript:return checkstd();">
          ...
          <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              ...
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><select name="session" class="style4" id="session" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
              ...
              <td height="26" align="right"><span class="style4">Blood Group<span class="stars">*</span></span></td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><span class="style4">
            ...
            <tr>
              <td height="26" align="right" class="style4"><span class="stars">*</span>Semester</td>
              <td height="26"><span class="style4">:</span></td>
            ...
            <tr>
              <td height="26" align="right" class="style4">Hostel</td>
              <td height="26"><span class="style4">:</span></td>
              ...
              <td height="26" align="right"><span class="style4">Father's Name<span class="stars">*</span></span></td>
              <td height="26"><span class="style4">:</span></td>
        ...
        <td height="60" colspan="2" valign="middle" bgcolor="#D3F3FE"><?php include("bot.php"); ?></td>
	        ...
	        <tr>
	          <td height="60" colspan="2" valign="middle" bgcolor="#D3F3FE">&nbsp;</td>
        </tr>
    </table></td>
  </tr>
</table>
