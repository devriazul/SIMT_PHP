...
<?php
	if (isset($_GET['eventID'])) {
		...
		$query = "DELETE FROM eventer_eventshces WHERE id='$eventID'";
...
<?php
	...
	$recset = mysql_query("SELECT count(id) as eventsCount FROM eventer_eventshces");
	$row = mysql_fetch_assoc($recset);
	...
	$query = "SELECT id, title FROM eventer_eventshces ORDER BY id DESC LIMIT $offset, $perPageLimit";
