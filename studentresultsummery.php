...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Students Result Summery Report </label>
		   Report	   
<div class="input">
		     <label></label>
		     <label></label>
...
<form name="MyForm" id="frm" autocomplete="off"  method="post"  target="_blank" action="rptstdresultsummery.php">           
	
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           <tr>
             <td width="22%" class="style11"><div align="left" class="style12">Department :</div></td>
             <td width="22%"><select name="deptid" id="deptid" onchange="show(this.value);" onkeypress="return handleEnter(this, event)">
             ...
             <td width="16%" class="style11"><div align="left" class="style12">Session :</div></td>
           ...
           <tr>
             <td class="style11"><div align="left" class="style12">Semester :</div></td>
             <td><select name="semesterid" id="semesterid" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
             ...
             <td class="style11"><div align="left" class="style12">Exam Held in Month :</div></td>
             <td width="23%"><input type="hidden" id="page" name="page" value=1/><select name="heldmonths" id="heldmonths" onkeypress="return handleEnter(this, event)">
