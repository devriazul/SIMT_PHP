...
$sql = "select f.name as empname, f.facultyid as facultyid from tbl_faculty f where f.name like '$q%' and f.type='Part Time'";
$rsd = mysql_query($sql);
?>
...
?>
    <option value="<?php echo $rs['facultyid']; ?>"><?php echo $rs['empname']; ?></option>
<?php 
