...
{ 
  	if($_SESSION['userid'])
	{
		...
		$edate=date("Y-m-d");
		$query="SELECT*FROM tbl_attendance WHERE efid='$uname' AND edate='$edate'";
     	$r=$myDb->select($query);
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblleft">
      ...
      <tr>
        <td width="21%" valign="top" background="images/leftbg.jpg">         <br />
          ...
          <p>&nbsp;</p>
          <p align="center"><span class="style16"><?php if($row==1){echo "Your attendance is collected successfully.";}else{echo "Your attendance has already collected today.";}?><p align="center"><a href="logout.php">Logout</a></p></span></p>
          </blockquote>
          <p>&nbsp;</p></td></tr>
      <tr>
