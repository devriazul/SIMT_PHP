...
$().ready(function() {
	$("#accno").autocomplete("search_acchead.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input1">
		   <form id="sfrm" method="post" autocomplete="off" action="Report/view_ledger.php" target="_blank">
			 <label><input type="text" name="accno" id="accno" align="left" style="text-align:left; width:150px;" placeholder="Accounts Head"  ></label>
			 <label><input name="fdate" type="text" class="style4" id="DPC_fdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" placeholder="From Date" style="text-align:left; width:150px;" /></label>
			 <label><input name="tdate" type="text" class="style4" id="DPC_tdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" placeholder="To Date" style="text-align:left; width:150px;" /></label>
