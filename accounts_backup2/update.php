	...
	<table width="450" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><select name="acctype" id="acctype" class="style2" onkeypress="return handleEnter(this, event)">
          <option selected="selected" value="<?php echo $results['type']; ?>" selected><?php echo $results['type']; ?></option>
	...
	<table width="450" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="30"><select name="groupname" class="style3" id="groupname" onkeypress="return handleEnter(this, event)">
		   ...
		   <?php $gn=mysql_query("select*from tbl_accchart where parentid in(select id from tbl_accchart where parentid=0)") or die(mysql_error());
