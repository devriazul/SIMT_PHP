  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
		   ...
		   <form id="sfrm" method="post" autocomplete="off" action="Report/cash_bankbookDtlRpt.php" target="_blank">
			 ...
			 <label><input name="fdate" type="text" class="style4" id="DPC_fdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" placeholder="From Date" /></label>
			 <label><input name="tdate" type="text" class="style4" id="DPC_tdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" placeholder="To Date" /></label>
