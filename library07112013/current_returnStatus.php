...
<div style="padding-left:20px;width:700px;" id="book-list"> 
		   ...
		   <form method="post" id="srs">
			 ...
			 <label>To Date:<input type="date" name="tdate" id="tdate" size="30" value="<?php echo date("Y-m-d"); ?>" onkeypress="return handleEnter(this, event)" min="<?php echo date("Y-m-d"); ?>"></label>
