  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
		   ...
		   <form id="sfrm" method="post" autocomplete="off" action="Report/viewJournalReport.php" target="_blank">
			 ...
			 <label><input name="fdate" type="text" class="style4" id="DPC_fdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" /></label>
			 <label><input name="tdate" type="text" class="style4" id="DPC_tdate_YYYY-MM-DD" size="30" onkeypress="return handleEnter(this, event)" /></label>
