		...
		<form name="MyForm" autocomplete="off" action="chart_of_acc.php" method="post" onsubmit="xmlhttpPost('ins_chartofacc.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          ...
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              ...
              <td height="20" ><div align="left">
                <input name="parenthead" type="text" id="parenthead" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onblur="xmlhttpPost1('accid.php', 'MyForm', 'myDiv2', '<img src=\'loader.gif\'>');" onkeypress="return handleEnter(this, event)" placeholder="Parent Head" size="60" />
              </div><div id="myDiv2">
