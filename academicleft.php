...
<?php 
																...
																$clat=mysql_query("SELECT id, name,user FROM `tbl_menucat` WHERE id in(select cid from tbl_menuscat) and status='Active' and section='Staff Panel'") or die(mysql_error());
...
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><?php $s1cat=mysql_query("select * from tbl_menuscat where cid='$clfetch[id]' AND status='Active'") or die(mysql_error());
