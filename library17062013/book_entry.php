...
$(document).ready(function(){
  ...
  $('#men').css({'font-family':'Verdana, Arial, Helvetica, sans-serif'}).css({'font-size':'12px'}).css({'font-weight':'bold'}).css({'color':'#999999'});
  $('#list-book').css({'font-family':'Verdana, Arial, Helvetica, sans-serif'}).css({'font-size':'12px'}).css({'font-weight':'bold'}).css({'color':'#999999'});
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                function loading_show(){
                    $('#loading').html("<img src='load.gif'/>").fadeIn('fast');
                }
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblleft">
      ...
      <tr>
        <td width="21%" valign="top" background="images/leftbg.jpg"><?php include("left.php");?>���������<br />
		  ...
		  <div style="float:left;margin-left:30px;" ><a href="#" id="men">Book Entry Form</a>|<a href="#" id="list-book">List View</a></div>
