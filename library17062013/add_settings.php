		...
		<div id="ms"></div>
          ...
          <table width="500" border="0" cellspacing="0" cellpadding="0" id="tbl-border">
            ...
            <tr>
              ...
              <td width="343" id="align"><input type="text" name="maxval" id="maxval" style="width:50px;" onkeypress="return handleEnter(this, event)" size="29"/></td>
            </tr>
            <tr>
              <td width="157" id="tbl_heading">Fine:</td>
              <td width="343" id="align"><input type="text" name="fine" id="fine" style="width:50px;" onkeypress="return handleEnter(this, event)" size="29"/></td>
            </tr>
            <tr>
              <td width="157">&nbsp;</td>
