		...
		<div id="bms"></div>
          ...
          <table width="500" border="0" cellspacing="0" cellpadding="0" id="tbl-border">
            ...
            <tr>
              ...
              <td width="345" id="align"><input type="text" name="selfno" id="selfno" value="<?php echo $bsqf['selfno']; ?>" style="width:50px;" onKeyPress="return handleEnter(this, event)" size="29"/></td>
            </tr>
           
            <tr>
              <td width="153" id="tbl_heading">Capacity :</td>
              <td width="345" id="align"><input type="text" name="capacity" id="capacity" value="<?php echo $bsqf['capacity']; ?>" style="width:50px;" onKeyPress="return handleEnter(this, event)" size="29"/></td>
            </tr>
            <tr>
              <td width="153">&nbsp;</td>
