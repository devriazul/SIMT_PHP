...
<form name="MyForm" action="rptstudentacademictranscript.php" id="MyForm" method="post" enctype="multipart/form-data"   onsubmit="Javascript:return checkValidity();"  target="_blank" >           
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           <tr>
             <td width="18%" class="style11"><div align="left">Department :</div></td>
             <td width="23%"><select name="deptid" id="deptid" onchange="show(this.value);" onkeypress="return handleEnter(this, event)">
