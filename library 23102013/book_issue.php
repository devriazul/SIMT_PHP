...
$(document).ready(function(){	 
  ...
  $('#bookentry<?php echo $_GET['rowid']; ?>').click(function(){
	  ...
	  $.post('ins_issuebook.php',arr,function(data){
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="267"><select name="deptid" id="deptid<?php echo $_GET['rowid']; ?>" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
  ...
  <tr>
    ...
    <td><input name="issue" type="text" class="style4" id="issuee<?php echo $_GET['rowid']; ?>" size="30" onkeypress="return handleEnter(this, event)" />
      [YYYY-MM-DD]</td>
    </tr>
