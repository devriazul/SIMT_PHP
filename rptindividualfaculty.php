...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='rptindividualfaculty.php' AND userid='$_SESSION[userid]'";
...
$().ready(function() {
	$("#searchid").autocomplete("search_faculty.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
$(document).ready(function(){
    	$('#searchid').keyup(function(e){
	       ...
	       $.post('showfaculty.php',arr,function(data){
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
		   ...
		   <form id="sfrm" method="post" autocomplete="off" action="">
			 ...
			 <label><input type="text" id="searchid" name="searchid" placeholder="Search by faculty ID" /></label>
		   </form>
		   </div>
		</div>
		</div>
