...
<?php 
																...
																$clat=mysql_query("SELECT id, name FROM `tbl_menucat` WHERE id in(select cid from tbl_menuscat) and status='Active' and section='Teachers Panel' order by position ASC") or die(mysql_error());
																while($clfetch=mysql_fetch_array($clat)){
															?>
<table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="21"><span style="font:Calibri; font-size:12px; font-weight:700; " ></br><?php echo $clfetch['name']; ?></span></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><?php $s1cat=mysql_query("select * from tbl_menuscat where cid='$clfetch[id]' AND status='Active' order by morder") or die(mysql_error());
        ...
        <tr>
          ...
          <td width="90%"><a href="<?php echo $s1fetch['url'];?>"><span style="font:Arial, Helvetica, sans-serif; font-size:10px; font-weight:bold; color:#000099; "><?php echo $s1fetch['name'];?></span></a></td>
        </tr>
    </table>
    <?php } ?></td>
  </tr>
