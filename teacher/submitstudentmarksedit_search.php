...
<form name="MyForm" id="frm" autocomplete="off"  method="post" >           
            ...
            <input name="marksper" type="hidden" class="numbersOnly" id="marksper"  style="width:90px; height:12px; text-align:center;" value="<?php echo $ivrs['exammarksper'];?>" maxlength="3" />
             ...
             <tr>
               <td width="47%" height="20"  class="style2"><table width="100%" border="0" cellspacing="0" align="center" cellpadding="0" class="gridTbl">
...
<script language="javascript">
                   $(document).ready(function(){
                      ...
                      $('#fmarks<?php echo $count; ?>').keyup(function(){
				  ...
				  <tr bgcolor="<?php echo $bgcolor; ?>">
                   <td height="25" class="gridTblValue"><?php echo $stdr['stdid']; ?>
                   ...
                   <td height="25" class="gridTblValue" align="center"><input name="fmarks" type="text" class="numbersOnly" id="fmarks<?php echo $count; ?>" value="<?php if($_POST['examtype']=="Class Test"){echo $stdr['classtestmarks'];} else if($_POST['examtype']=="Quiz Test"){echo $stdr['quiztestmarks'];} else if($_POST['examtype']=="Theory Final Exam"){echo $stdr['finalexammarks'];} else if($_POST['examtype']=="Practical Final Exam"){echo $stdr['finalexamprac'];} else if($_POST['examtype']=="Attendance Theory Cont"){echo $stdr['attendancemarks'];} else if($_POST['examtype']=="Attendance Practical Cont"){echo $stdr['attendancemarksprac'];} else if($_POST['examtype']=="Behavior"){echo $stdr['behaviormarks'];} else if($_POST['examtype']=="Home Work"){echo $stdr['hwmarks'];} else if($_POST['examtype']=="Job/Experiment"){echo $stdr['jobexpr'];} else if($_POST['examtype']=="Job/Experiment Final"){echo $stdr['jobexprfinal'];} else if($_POST['examtype']=="Job/Experiment Report"){echo $stdr['jobexprreport'];} 
			...
			?>
             ...
             <tr>
               <td height="20" class="style2"><span class="nyroModal"><span class="style4">
                 <input type="button" class="sbmt" id="sbmt" value="Update Marks" style="color: #999999; font-size: 8pt; font-family: Verdana; border: 1px solid #C0C0C0; background-color: #D9F0FB" />
               </span></span></td>
              </tr>
             <tr>
