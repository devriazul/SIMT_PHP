...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	...
	$.post('submitstudentmarksedit_search.php?courseid='+courseid,arr,function(result){
...
<div class="transbox"><div id="bothead" style=" position:absolute; background-color:#666666;   padding:10px; color:#FFFFFF; left:400px;float:right;width:700px; height:auto; display:none; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
   ...
   HOW TO SEARCH/ UPDATE STUDENT MARKS:<br/>
  -------------------------------------------------------------<br/><br/>
   ...
   <label>* Type a Student ID to Edit his/her Marks.</label><br/> 
   <label>* Then Press "Next" button</label><br/>
   <label>* Now you can easily Edit student Final Mark of selected Exam.</label><br/>
   <label>* Finally click "Update Marks" to Edit student Mark of selected Exam.</label><br/> <br/><br/>
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Edit  Students Submited Marks</label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             <td class="style15">Student ID:</td>
             <td><input type="text" id="stdid" name="stdid" /></td>
             <td class="style15">&nbsp;</td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
           </tr>
