...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	...
	$.post('reportstudentmarks_search.php?courseid='+courseid,arr,function(result){
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Student Result Report </label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             <td width="16%" class="style15"><label>Department :
             </label></td>
             <td width="38%"><label>
           ...
           <tr>
             ...
             <td width="14%" class="style15"><div align="right">Semester :</div></td>
             ...
             <td width="10%"><span class="style4">
               <select name="section" class="style2" id="select" style="font-family: Verdana; width:50px; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" onchange="showSelected();">
