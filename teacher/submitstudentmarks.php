...
<div class="transbox"><div id="bothead" style=" position:absolute; background-color:#666666;   padding:10px; color:#FFFFFF; left:400px;float:right;width:700px; height:auto; display:none; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
   ...
   HOW TO SEARCH STUDENTS MARKS:<br/>
  ---------------------------------------------<br/><br/>
   ...
   <label>* Select a year (in which year the exam was taken).</label><br/> 
   <label>* Select a Exam Type (i.e: Class Test/ Quiz Test/ Theory Final Exam, Practical Final Exam etc...).</label><br/> 
   <label>* Now Press "Next" button(student lists will arrived on the base of selected combination with Exam Marks)</label><br/> <br/><br/>

	HOW TO SUBMIT FINAL MARKS<br/>
  	---------------------------------------------<br/><br/>
   <label>After clicking the "Next" button student lists will arrive with selected exam marks. Beside that marks column there will be another column where you can enter Final Marks. Finally click "Submit Marks" to submit students Final Marks.</label><br/><br/>
   <label>Class Test------Incase of Class Test if you take multiple class test (According to rules) then every Class Test Marks will be shown by parallel textbox. And you can enter final mark of Class Test on the basis of all Class Test Marks</label><br/><br/>
   <label>Quiz Test------Incase of Quiz Test if you take multiple class test (According to rules) then every Quiz Test Marks will be shown by parallel textbox. And you can enter final mark of Quiz Test on the basis of all Quiz Test Marks.</label><br/>
 ...
 <div class="search-background1">
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             ...
             <td align="left"><div align="right"><span class="style15">Course :</span></div></td>
             <td colspan="2" align="left"><div id="sub"></div></td>
             </tr>
           <tr>
             ...
             <td><select name="session" class="style2" id="session" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" >
               ...
               <?php 
				   ...
				   ?>
               <option value="<?php echo $srow['SESSION']; ?>"><?php echo $srow['SESSION']; ?></option>
               <?php } ?>
             </select></td>
             ...
             <td width="7%"><span class="style4">
               <select name="section" class="style2" id="section" style="font-family: Verdana; width:60px; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" onchange="showSelected();">
