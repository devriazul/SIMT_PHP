...
if(($rmval['amountdr']==$rmval['amountcr'])&&($rmval['amountdr']!=0&&$rmval['amountcr']!=0)){
   $level="<div style='color:#CC6600;font-weight:bold;padding-left:3px;'>A voucher still waiting for saving!you have to save the voucher first then start new one</div>";
   echo $level;
}  
