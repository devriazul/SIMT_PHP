...
if($rmval['amountdr']==$rmval['amountcr']){
 ...
 // echo $level;
  ...
  $level="<div style='color:#CC6600;font-weight:bold;padding-left:3px;'>Debit and Credit not level <br/>you have to complete the voucher first or delete the voucher from queue</div>";
  echo $level;
