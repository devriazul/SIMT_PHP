...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
      ...
      <td height="30" class="m-header" style="border-top:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;"><?php if($bb>0){ echo number_format($bb,2); }else{ ?>
          <?php  echo 0; } ?></td>
      <td height="30" class="m-header" style="border-top:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;" ><?php if($cc<0){ echo number_format(-($cc),2); }else{ ?>
          <?php  echo 0; }  ?></td>
    </tr>
</table>
