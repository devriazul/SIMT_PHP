...
<table width="70%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="7"><div class="cls<?php echo $count.$j; ?>" style="float:right;display:none;background-image:url(../icons/cancel.png); height:50px; position:absolute; width:50px; background-position:right; background-repeat:no-repeat; "></div><div id="shwj<?php echo $count.$j; ?>" style="width:700px;"  align="right"></div></td>
    </tr>
  <tr>
...
<tr>
   <td align="right">&nbsp;</td>
    <td align="right">&nbsp;</td>
    <td align="left" style="border-top:1px solid #999999;"><?php echo "Dr. ".number_format($amountc,2);  ?></td>
    <td align="right" style="border-top:1px solid #999999;"><?php echo "Cr. ". number_format($amountd,2); ?></td>
    <td></td>
    <td></td>
 </tr>
</table>
