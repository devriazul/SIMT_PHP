...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		...
		<div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" action="manage_admissionfees1.html">
			 ...
			 <label><a href="add_admission_fees.html"><input type="button" name="addbtn" id="submit-btn" value="Add New" /></a></label>
				...
				<form name="MyForm" autocomplete="off" action="add_admission_fees.php" method="post" onsubmit="xmlhttpPost('insAdm.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
      ...
      <tr>
        ...
        <td height="30"><label>
          <input name="edate" type="text" class="style15" id="DPC_edate_YYYY-MM-DD" onkeypress="return handleEnter(this, event)" value="<?php echo date("Y-m-d"); ?>" />
        </label></td>
        <td width="156" height="30" style="padding:5px;"><div align="left">&#2488;&#2509;&#2463;&#2497;&#2465;&#2503;&#2472;&#2509;&#2463; &#2438;&#2439;&#2465;&#2495; &#2470;&#2495;&#2472;</div></td>
        <td width="266"><input name="stdid" type="text" class="style15" id="stdid" onkeypress="return handleEnter(this, event)" onblur="xmlhttpPost1('sname.php', 'MyForm', 'myDiv2', '<img src=\'loader.gif\'>');" /></td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<p align="center">
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
  <tr >
    <td width="77%" height="26" bgcolor="#F7FCFF" style="border-bottom:1px solid #DFF6FE; padding:5px;" ><div align="left"><strong>&#2476;&#2495;&#2476;&#2480;&#2472; </strong></div></td>
    <td width="23%" bgcolor="#F7FCFF" style="border-bottom:1px solid #DFF6FE; padding:5px;" ><div align="left"><strong>&#2463;&#2494;&#2453;&#2494; </strong></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <select name="tomonth" class="style11" id="tomonth" onkeypress="return handleEnter(this, event)">
	    <option value="<?php echo date("m"); ?>" selected="selected"><?php 
		  switch(date("m")){
		     case "01":
			    echo "&#2460;&#2494;&#2472;&#2497;&#2527;&#2494;&#2480;&#2495;";
				break;
