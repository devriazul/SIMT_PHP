...
<script language="javascript">
		$(document).ready(function(){
		     $('#semester').change(function(){
				...
				var s=$('#session').val();
				var y=$('#year').val();
				  $.get('showselected.php?deptid='+deptid +'&semester='+semester+'&s='+s+'&y='+y,function(r){
				  $('#Result').html(r);
				});
			 });
		});   
...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	 ...
	 $.post('manageexam_search.php?courseid='+courseid,arr,function(result){
...
.style19 {font-family: Calibri; font-weight: bold; }
-->
</style>
</head>
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<div id="top-search-div"> 
           <div id="content">
		   <label>Manage Examination </label>
		   <div class="input">
		     <label></label>
		     <label></label>
			 <label></label>
			 <label style="float:right"><a href="add_examinformation.php"><input type="button" name="addbtn" id="submit-btn" value="Add New" /></a></label>
		   </div>
		</div>
		</div>
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           <tr>
             <td width="23%" height="30" bgcolor="#D9F0FB" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"><span class="style19">Department</span></div></td>
             <td width="7%" height="30" bgcolor="#CCFF99" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"><span class="style19">Year</span></div></td>
             <td width="12%" height="30" bgcolor="#FFCCCC" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"><span class="style19">Session</span></div></td>
             <td width="23%" bgcolor="#FFCCFF" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"><span class="style19">Semester</span></div></td>
             <td bgcolor="#FFFFCC" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"><span class="style19">Subject</span></div></td>
             <td height="30" bgcolor="#D9F0FB" style="font-family:Verdana, Arial, Helvetica, sans-serif;
	font-size:14px;	"><div align="center"></div></td>
           </tr>
	<form name="MyForm" id="MyForm" autocomplete="off"  method="post" >
           <tr>
             <td><label>
               <select name="department" id="department" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, 
)">
             ...
             <td><label>
               <input name="year" type="text" id="year" size="15" style="font-family: Verdana; width:50px; font-size: 8pt;padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)"  />
             </label></td>
             <td><label>
               <select name="session" id="session" style="font-family: Verdana; font-size: 8pt; width:100px; padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" onchange="showSelected();">
             ...
             <td><label>
               <select name="semester" id="semester" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
             ...
             <td width="28%"><div id="Result" align="left"></div></td>
             <td width="7%"><label>
