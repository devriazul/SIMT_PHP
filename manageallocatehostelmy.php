        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
					...
					$.get("student_paginationd.php?page="+page+"&stdidsrch="+qstid+"&searchid="+searchid,function(msg){
                                loading_hide();
                                $("#container").html(msg);
					});             
                }
				...
				$('#searchid').keyup(function(){
				   var arr=$('#stdsearch').serializeArray();
					var qstid='<?php echo $qstdf["stdid"]; ?>';
				   $.post("student_paginationd.php?page=1&stdidsrch="+qstid,arr,function(r){
				     $('#container').html(r);
				   });
				   //$('#container').hide();
