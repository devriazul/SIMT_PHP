...
<?php if(isset($_GET['submitted'])) { 
	...
	$newCategory = mysql_query("INSERT INTO tbl_accchart (parentid, accname, type, orderby, opby, opdate, storedstatus,groupname) 
								VALUES ('".$_POST['parent_id']."','".$_POST['accname']."','".$_POST['acctype']."',
...
<table width="350" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="30"><select name="groupname" class="style3" id="groupname" onkeypress="return handleEnter(this, event)">
		  ...
		  <?php }else{ ?>
		   <?php $gn=mysql_query("select*from tbl_accchart where id='$_GET[category_id]'") or die(mysql_error());
          ...
          <option value="<?php echo $cgnf['id']; ?>"><?php echo $cgnf['accname']; ?></option>
		  <?php  } ?>
        </select></td>
        <td>&nbsp;</td>
      </tr>
