	...
	<?php if (!empty($_SESSION['userid'])) { 
		...
		?>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat" width="100%">
				...
				<?php 
				$uac=$myDb->select("SELECT accno,accname,amountdr,amountcr,masteraccno FROM tbl_tmpjurnal WHERE masteraccno<>0 AND opby='$_SESSION[userid]' AND vdate='".date("Y-m-d")."'");
				...
				?>
					...
					<tr>
						...
						<td class="ta_r">
							<a href="#" class="remove" rel="<?php echo $uacf['masteraccno']; ?>">
								Remove
							</a>								
						</td>
					</tr>
