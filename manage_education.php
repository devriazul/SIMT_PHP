...
//getting number of rows and calculating no of pages
  if(isset($_GET['searchid'])){ 
    $sql = "select * from  tbl_stdinfo WHERE stdid LIKE '%$_GET[stdid]%' and storedstatus<>'D' limit $start,$per_page";  
	$rsd = mysql_query($sql);
    $count = mysql_num_rows($rsd);
    $pages = ceil($count/$per_page);

  }else{
    $sql = "select * from  tbl_stdinfo WHERE storedstatus<>'D'";
	$rsd = mysql_query($sql);
    $count = mysql_num_rows($rsd);
    $pages = ceil($count/$per_page);
  }	
...
<br />
		  <div align="center"><?php include("education1.php"); ?>
