...
<div style="width:auto; margin:0 auto;">
  <div class="logo"></div><h2>SAIC GROUP OF INSTITUTIONS<br />
...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="17%" height="30" bgcolor="#0066FF"><span class="style30">Date</span></td>
    <td width="11%" height="30" bgcolor="#0066FF">&nbsp;</td>
    <td width="21%" height="30" bgcolor="#0066FF"><span class="style30">Particulars</span></td>
    <td width="7%" height="30" bgcolor="#0066FF"><span class="style30">VType </span></td>
    <td width="18%" height="30" bgcolor="#0066FF"><span class="style30">Vch No </span></td>
    <td width="8%" height="30" bgcolor="#0066FF"><span class="style30">Dr</span></td>
    <td width="7%" height="30" bgcolor="#0066FF"><span class="style30">Cr</span></td>
  ...
  <?php $sum1=0;$sum2=0;$ob1=0;$ob2=0;
		$cht=mysql_query("select ifnull(sum(c.amountdr),0) amountdr,ifnull(sum(c.amountcr),0) amountcr
							...
							and c.accname not in(select accname from tbl_2ndjournal where accname like '$_POST[accno]%')
							and c.voucherid in(select voucherid from tbl_2ndjournal where accname like '$_POST[accno]%')
  ...
  <tr>
    ...
    <td height="30">&nbsp;</td>
    <td height="30"><?php if($opvalue>=0){ echo $opvalue; } ?></td>
    <td height="30"><?php if($opvalue<0){ echo (-($opvalue)); }  ?></td>
    <td height="30">&nbsp;</td>
    <td height="30">&nbsp;</td>
  </tr>
  ...
  <?php 
  $adr=0;$acr=0;
		$ts1=mysql_query("select * from tbl_2ndjournal where accname like '$_POST[accno]%' and vdate between '$_POST[fdate]' and '$_POST[tdate]'") or die(mysql_error());
		while($tsf1=mysql_fetch_array($ts1)){
     $cq=mysql_query("select* from tbl_2ndjournal where  accname not in(select accname from tbl_2ndjournal where accname like '$_POST[accno]%') and vdate between '$_POST[fdate]' and '$_POST[tdate]' order by vouchertype") or die(mysql_error());
  ...
  ?>  
    ...
    <tr>
      ...
      <td height="30">&nbsp;</td>
      <td height="30">&nbsp;</td>
      <td height="30" style="border-top:1px solid #999999; "><?php   if($opvalue<0){ echo (((-($opvalue))+$adr)-($acr)); }  ?></td>
      <td height="30" style="border-top:1px solid #999999; "><?php if($opvalue>=0){ echo (($opvalue+$adr)-($acr)); } ?></td>
      <td height="30">&nbsp;</td>
      <td height="30">&nbsp;</td>
    </tr>
