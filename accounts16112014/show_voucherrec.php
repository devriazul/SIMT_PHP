	...
	$(document).ready(function(){
		$(".adr<?php echo $count; ?>").keyup(function(){
		    ...
		    if($(this).val()==0&&$(this).val().length==1){
				 window.location.href = "http://localhost/simt/accounts/manage_voucher.php";
			}
  ...
  ?>
	   <tr>
		...
		<?php if($vrecf['masteraccno']==0){ ?>
			   <input type="text" class="adr<?php echo $count; ?>" name="amountdr[]" id="amountdr_m<?php echo $count; ?>"  value="<?php echo $vrecf['amountdr']; ?>"  style="width:100px; background-color:#CCCCFF;" readonly="true" attr="<?php echo $vrecf['id']; ?>" />
		<?php }else{ ?>
		...
		<?php if($vrecf['masteraccno']==0){ ?>
				...
				<input type="text" class="acr<?php echo $count; ?>" name="amountcr[]" id="amountcr_m<?php echo $count; ?>"  value="<?php echo $vrecf['amountcr']; ?>"  style="width:100px; background-color:#CCCCFF;" readonly="true" attr="<?php echo $vrecf['id']; ?>"/>
