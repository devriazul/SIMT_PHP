...
{ 
  	if($_SESSION['userid'])
	{
		...
		{ $id=mysql_real_escape_string($_GET['id']);
		  $edrec=$myDb->select("SELECT*FROM tbl_accchart where id='$id' and parentid>0 and groupname=0 and storedstatus<>'D'");
          ...
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              ...
              <td height="20"><select name="parentid" id="parentid" class="style2" onkeypress="return handleEnter(this, event)">
				...
				<?php $rt=$myDb->select("SELECT id,accname from tbl_accchart where parentid=0 and groupname=0 and storedstatus<>'D' order by id asc");
