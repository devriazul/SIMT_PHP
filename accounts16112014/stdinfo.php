...
<form name="MyForm" action="insSTD.php" method="post" enctype="multipart/form-data" onsubmit="Javascript:return checkstd();">
          ...
          <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              ...
              <td height="26" class="style4">:</td>
              <td width="32%" height="26" class="style4"><input name="stdname" type="text" id="stdname" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" size="40" onkeypress="return handleEnter(this, event)"/></td>
              <td width="18%" align="right" class="style4"><span class="stars">*</span>Password</td>
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>DOB</span></td>
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Blood Group</span></td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><span class="style4">
            ...
            <tr>
              ...
              <td height="26" colspan="3"><div id="myDiv1">
            ...
            <tr>
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Semester</span></td>
              <td height="26" class="style4">:</td>
              <td height="26"><select name="semester" class="style4" id="semester" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
                <option value="">Select</option>
                <?php $dq="SELECT * FROM tbl_semester WHERE storedstatus IN('I','U') order by id desc";
				      $dr=$myDb->select($dq);
					  while($drow=$myDb->get_row($dr,'MYSQL_ASSOC')){
				?>
            ...
            <tr>
              <td height="26" align="right"><span class="style4">Hostel</span></td>
              <td height="26" class="style4">:</td>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Father's Name</span></td>
              <td height="26" class="style4">:</td>
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Religion</span></td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><span class="style4">
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Permanent Address</span></td>
              <td height="26"><span class="style4">:</span></td>
            ...
            <tr>
              ...
              <td height="26" align="right"><span class="style4"><span class="stars">*</span>Image</span></td>
              <td height="26"><span class="style4" >:</span></td>
