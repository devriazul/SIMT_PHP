...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='manage_acc_head.php' AND userid='$_SESSION[userid]' and storedstatus<>'D'";
 ...
 <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
					...
					$.post("acc_head_pagination.php?page="+page,arr,function(msg){
                                loading_hide();
                                $("#container").html(msg);
					});
                }
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><div align="center"><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])){ ?><span style="color:#FF6600; font-weight:bold;"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></span><?php } ?></font></div></font></p>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input1">
		   <form id="sfrm" method="post" autocomplete="off" action="add_acc_head.php">
			 <label><input type="text" name="accno" id="accno" align="left" style="text-align:left; width:150px;" ></label>
			 <label><input type="button" name="addbtn1" class="submit-btn" value="Search" /></label>
