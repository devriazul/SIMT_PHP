...
<div id="top-search-div"> 
		 ...
		 <div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" action="requisition1.php">
			 ...
			 <label><a href="add_approve.php"><input type="button" name="addbtn" id="submit-btn" value="Approve Requisition" /></a></label>
			 <label><a href="add_purchase.php"><input type="button" name="addbtn" id="submit-btn" value="Purchase Product" /></a></label>
			 <label><a href="stock_entry.php"><input type="button" name="addbtn" id="submit-btn" value="Add Stock" /></a></label>
		   </form>
		   </div>
		 </div>
		 </div>
