...
<script language="javascript">
  $(document).ready(function(){
	 ...
	 $('#submit').click(function(){
	   ...
	   if($('#packsize').val()==""){
	     alert("Packsize can not left empty");
		 $('#packsize').focus();
		 return false;
	   }	 
	   if($('#prtype').val()==""){
...
<table width="1047" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="30" colspan="3" style="border-bottom:1px solid #333333; background-color:#CCCCCC; padding:3px; ">Edit Product </td>
  </tr>
  ...
  <tr>
    ...
    </label><input type="hidden" id="id" name="id" value="<?php echo $id; ?>" /></td>
  </tr>
  <tr>
    <td>Pack Size</td>
    <td>:</td>
    ...
    <td>Product Type</td>
    <td>:</td>
    <td><label><input type="text" name="prtype" id="prtype" onkeypress="return handleEnter(this, event)" value="<?php echo $prof['prtype']; ?>"/>[Auto complete Box ,Example:stationary,HouseKeeping]
    </label></td>
  </tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input type="text" name="mname" id="mname" onkeypress="return handleEnter(this, event)" value="<?php echo $prof['mname']; ?>"/>
        [Auto complete Box ,Example:Pran,Square] </label></td>
    </tr>
  <tr>
    <td>Opening Value </td>
    <td>:</td>
