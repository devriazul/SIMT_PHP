...
<table width="80%" border="0" cellspacing="0" cellpadding="0" class="tbl_repeat" style="padding:5px;margin:5px;" >
  ...
  <?php 
  $pr=$myDb->select("select*from tbl_product LIMIT $start, $per_page");
  ...
  <tr>
    ...
    <td height="30"><span class="style8"><?php echo $bprf["Purchase Qty"]; ?></span></td>    
	<td height="30"><span class="style8"><?php echo $bprf["Issue Qty"]; ?></span></td>
		<td height="30"><span class="style8"><?php echo $bprf["Stock Qty"]; ?></span></td>
	<td height="30"><span class="style8"><?php echo $bprf["Remaining Qty"]; ?></span></td>
  </tr>
  <?php } }?>
</table>
