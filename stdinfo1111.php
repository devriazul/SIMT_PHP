...
<form name="MyForm" action="insSTD.php" method="post" enctype="multipart/form-data" onsubmit="Javascript:return checkstd();">
          <br />
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            ...
            <tr>
              <td height="26" class="style4">Name<span class="stars">*</span></td>
              <td height="26" class="style4">:</td>
            ...
            <tr>
              <td height="26" class="style4">Sex<span class="stars">*</span></td>
              <td height="26" class="style4">: </td>
            ...
            <tr>
              <td height="26" class="style4">Session<span class="stars">*</span></td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26">
            ...
            <tr>
              <td height="26" class="style4">Department<span class="stars">*</span></td>
              <td height="26"><span class="style4">:</span></td>
              <td height="26"><select name="deptname" class="style4" id="deptname" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
                <option value="">Select</option>
				<?php $dq="SELECT code FROM tbl_department order by id desc";
				      $dr=$myDb->select($dq);
            ...
            <tr>
              <td height="26"><span class="style4">Hostel</span></td>
              <td height="26">&nbsp;</td>
            ...
            <tr>
              <td height="26"><span class="style4">Mother's Name<span class="stars">*</span></span></td>
              <td height="26">&nbsp;</td>
            ...
            <tr>
              <td height="26" class="style4">Present Address<span class="stars">*</span></td>
              <td height="26" class="style4">:</td>
            ...
            <tr>
              <td height="26" valign="top" class="style4">Phone<span class="stars">*</span></td>
