...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
	 ...
	 $sdq="SELECT id, code AS Code, name AS Name, admissionfee AS AdFee, labfee AS LabFee, libraryfee AS LibFee, idcardfee AS IDCardFee, regifee AS RegiFee, onetimefee AS TotalFee, (
			noofsemester * semesterfee
			) AS TotalSemesterFee, (
			noofmonths * tuitionfee
			) AS TotalTuitionFee, credit AS Credit
			FROM tbl_department
			WHERE name LIKE '%$searchid%' AND storedstatus<>'D' order by id desc";
