...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
   		<form name="MyForm" id="frm" action="reportindvattendancehtml.php" method="post"  target="_blank" >
          <div align="center">            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            ...
            <tr>
              ...
              <td><input type="date" id="fromdate" name="fromdate" style="width:140px" value="<?php echo date('Y-m-d');?>" /></td>
              <td><span class="style2">To :</span></td>
              <td><input type="date" id="todate" name="todate" style="width:140px" value="<?php echo date('Y-m-d');?>"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
