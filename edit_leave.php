...
<div id="top-search-div"> 
		   ...
		   <div class="input">
		   <form method="post" autocomplete="off" action="manageleave1.php">
		     <label>Search Form</label>
			 <label><input type="text" id="searchid" name="searchid" placeholder="Search by leave name" /></label>
			 <label><input type="submit" name="subs" id="submit-btn" value="Search" /></label>
			 <label><a href="add_leave.php"><input type="button" name="addbtn" id="submit-btn" value="Add New" /></a></label>
		...
		<br />
		<form name="MyForm" autocomplete="off" action="edit_leave.php?" method="post" onsubmit="xmlhttpPost('ed_leave.php?id=<?php echo $id; ?>', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="5" id="stdtbl">

            <tr>
              <td height="20" colspan="2" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">LEAVE INFORMATION (<span class="stars">*</span>Mandatory Field) </span></td>
              </tr>
            <tr>
              <td width="31%" height="20" class="style2">Name:<span class="stars">*</span></td>
              <td width="69%" height="20"><input name="name" type="text" id="name" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $row['name']; ?>" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">Code :<span class="stars">*</span> </td>
              <td height="20"><input name="code" type="text" id="code" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $row['code']; ?>" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">No of Days Count  :<span class="stars">*</span> </td>
              <td height="20"><input name="dayscount" type="text" id="dayscount" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $row['dayscount']; ?>" /></td>
            </tr>
            <tr>
