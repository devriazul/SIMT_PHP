...
$().ready(function() {
	...
	$("#searchdname").autocomplete("search_department.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
				...
				$('#searchid').keyup(function(){
				  ...
				  $.post("course_pagination.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
				
				});  
				$('#searchdname').keyup(function(){
				  var arr=$('#frmsrch').serializeArray();
				  $.post("course_pagination.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
...
<div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" id="frmsrch" name="frmsrch" action="#">
			 ...
			 <label><input type="text" id="searchdname" name="searchdname" placeholder="Search by dept name" /></label>
