    ...
    <td colspan="2" align="center"><table width="80%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td><strong>Subject: Prayer for 
          ...
          from/on ' <?php echo $row['frmdate'];?>' to' <?php echo $row['todate'];?>' . </strong></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        <td>I have the honor to state that I need <?php echo $row['tdays']+1;?> day(s) <?php if($row['applyfor']=="AL") {echo "Annual";}elseif($row['applyfor']=="SL") {echo "Sick";}elseif($row['applyfor']=="CL") {echo "Casual";} ?> leave on account of '<?php echo $row['frmdate'];?>' from/on '<strong><?php echo $row['todate'];?></strong>'</td>
      </tr>
    </table>
