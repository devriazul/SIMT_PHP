 ...
 <div class="search-background1">
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             ...
             <td><input name="year" type="text" id="year3" size="15" style="font-family: Verdana; font-size: 8pt;padding:3px; border: 1px solid #3399FF" value="<?php echo date("Y"); ?>" onkeypress="return handleEnter(this, event)" readonly="true" /></td>
