 ...
 <div class="search-background1">
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             ...
             <td><select name="bm" class="style4" id="mb" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" onchange="showSelected();" >
