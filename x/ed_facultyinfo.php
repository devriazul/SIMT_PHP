...
{ 
  ...
  */
	...
	$qup="UPDATE tbl_faculty SET `name`='$name',`fname`='$fname',`mname`='$mname',`sex`='$sex',`dob`='$dob',`mstatus`='$mstatus',`bloodgroup`='$bg',`address`='$paddress',`deptid`='$deptid',`designationid`='$desigid',`joiningdate`='$jdate',`expartincourse`='$expsub',`eduqualification`='$eduq',`expyear`='$eyear',`expmonth`='$emonth',`contactno`='$contactno',`type`='$emptype',`payscaleid`='$payscaleid',`storedstatus`='U' WHERE `facultyid`='$id'";
