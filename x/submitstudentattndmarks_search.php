             ...
             <tr>
               <td width="47%" height="20" class="style2"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="stdtbl">
                 ...
                 <tr bgcolor="<?php echo $bgcolor; ?>">
                   ...
                   <td class="style4" align="center"><input name="tnd" type="text" class="numbersOnly" id="tnd<?php echo $count; ?>" style="width:90px; height:12px; text-align:center;" onKeyPress="return handleEnter(this, event);" maxlength="3" /></td>
