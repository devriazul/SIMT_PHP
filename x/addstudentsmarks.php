...
?>
        ...
        <table width="832" border="0" cellspacing="0" cellpadding="0" id="stdtbl">
          <tr bgcolor="#DFF4FF">
            <td width="351" height="25" class="style15">Student Name</td>
            <td width="290" height="25" class="style15">Student ID              </td>
			
            <td width="191" class="style15"><div align="center">Obtained Marks</div></td>
          </tr>
          <?php
			      //$csession=date("y").date("y")+1;
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            <td height="25" class="style4"><?php echo $stdr['stdname']; ?><input type='hidden' name='examid' id='examid' value="<?php echo $_GET['examid'];?>"  ><input type='hidden' name='deptid' id='deptid' value="<?php echo $_GET['deptid'];?>"  ><input type='hidden' name='courseid' id='courseid' value="<?php echo $_GET['courseid'];?>"  ><input type='hidden' name='session' id='session' value="<?php echo $_GET['session'];?>"  ><input type='hidden' name='semesterid' id='semesterid' value="<?php echo $_GET['semesterid'];?>"  ><input type='hidden' name='eyear' id='eyear' value="<?php echo $_GET['eyear'];?>"  ></td>
            ...
            <td height="25" class="style4"><div align="center">
			  <input name='marks[]' type='textbox' id='marks[]' maxlength="3" class="numbersOnly"  onKeyPress="return handleEnter(this, event)" >
</div></td>
		    </tr>
         <?php
			  $count++;
