...
<script language="javascript">
 $(document).ready(function(){
    $('.submit1').click(function(){
	  ...
	  $.post('data.php?count='+fid,arr,function(result){
...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           <tr>
             <td width="54%" height="30" bgcolor="#D9F0FB" class="style15">DEPARTMENT</td>
...
<form name="MyForm<?php echo $count; ?>" id="MyForm<?php echo $count; ?>" autocomplete="off"  method="post">           <tr>
             <td><label><input type="hidden" name="semester" id="semester" value="<?php echo $stdr['id']; ?>" />
               <select name="department" id="department" style="font-family: Verdana; font-size: 8pt; width:280px; padding:3px; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)">
