        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
					...
					var stdbr=$('#stdbr').val();
					$.get("student_pagination.php?page="+page+"&stdidsrch="+qstid+"&searchid="+searchid+"&stdbr="+stdbr,function(msg){
                                loading_hide();
                                $("#container").html(msg);
					});             
                }
				...
				$('#searchid').keyup(function(){
				   var arr=$('#stdsearch').serializeArray();
					var qstid='<?php echo $qstdf["stdid"]; ?>';
				   $.post("student_pagination.php?page=1&stdidsrch="+qstid,arr,function(r){
				     $('#container').html(r);
				   });
				   //$('#container').hide();
				   //$('#sstd').load("search_student_pagination.php?stdid="+sstd);
				});  
...
<div id="top-search-div"> 
		   ...
		   <form method="post" id="stdsearch" name="stdsearch" autocomplete="off" action="">
			 ...
			 <label><input type="text" id="stdname" name="stdname" placeholder="Search by student name" style="width: 120px; " /></label>
			 <label><input type="text" id="searchid" name="searchid" placeholder="Search by studentID" style="width: 120px; " /></label>
			 <label><input type="text" id="stdbr" name="stdbr" placeholder="Search by BoardRoll" style="width: 120px; " /></label>
