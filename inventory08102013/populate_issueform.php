...
<script language="javascript">
		$(function (){ var rid=$('#appdate').val();
			...
			$('#issuedate').dateEntry({spinnerImage: 'img/calendar_icon.png'});
		});
...
<form name="sfrm" id="sfrm" method="post">
  ...
  <tr>
    ...
    <tr>
      ...
      <td></td>
      <td>ISSUE DATE </td>
      <td colspan="3"><input type="text" name="issuedate" id="issuedate" onkeypress="return handleEnter(this, event)" readonly="true"  value="<?php echo date("Y-m-d"); ?>"/></td>
      </tr>
    <tr>
    <td width="124">      </td>
    <td width="6"></td>
