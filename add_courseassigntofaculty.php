...
<script src="courseassigntofaculty.js" type="text/javascript"></script>
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		<form name="MyForm" autocomplete="off" action="add_courseassigntofaculty.php" method="post" onsubmit="xmlhttpPost('ins_courseassigntofaculty.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
            <table width="70%" border="0" align="center" cellpadding="0" cellspacing="5" id="stdtbl">

            <tr>
              <td height="36" colspan="2" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">SUBJECT ASSIGN TO FACULTY(<span class="stars">*</span>Mandatory Field) </span></td>
              </tr>
            <tr>
              <td height="20" class="style2">Faculty Name :<span class="stars">*</span> </td>
              <td height="20"><select name="facultyid" id="facultyid" onkeypress="return handleEnter(this, event)">
            ...
            <tr>
              ...
              <td width="69%" height="20"><select name="deptid" id="deptid" onchange="show(this.value);" onkeypress="return handleEnter(this, event)">
