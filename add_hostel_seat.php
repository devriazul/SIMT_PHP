...
<div id="top-search-div"> 
		...
		<br />
		<form name="MyForm" autocomplete="off" action="add_hostel_seat.php" method="post" onsubmit="xmlhttpPost('ins_hostel_seat.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="5" id="stdtbl">
            ...
            <tr>
              ...
              <td height="20"><input name="roomno" type="text" id="roomno" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
            </tr>
            
            <tr>
              <td><span class="style2">No Of Students Per Room:<span class="stars">*</span></span></td>
              <td><input name="noofstudent" type="text" id="noofstudent" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
            </tr>
            <tr>
              <td></td>
