...
<div id="top-search-div"> 
		   ...
		   <div class="input">
		   <form method="post" autocomplete="off" action="leaveapplicationstatus1.php">
		     <table width="633" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td width="139">Search Form</td>
                 <td width="164"><input type="text" id="fdate" name="fdate" style="width:80px" value="<?php echo date('Y-m-d');?>" /></td>
                 <td width="120"><input type="text" id="tdate" name="tdate" style="width:80px"value="<?php echo date('Y-m-d');?>"/></td>
                 <td width="16">&nbsp;</td>
                 <td width="66">ID :</td>
                 <td width="19"><input type="text" id="empid" placeholder="Enter ID" name="empid" style="width:80px" /></td>
                 <td width="109"><input type="submit" name="subs" id="subs" value="Search" /></td>
               </tr>
             </table>
		     <label></label>
			 <label>			 </label>
      ...
      <tr bgcolor="" id="tbl">
       <td colspan="9"><div id="myDiv<?php echo $count; ?>" style="width:800px;" align="center"></div></td>
