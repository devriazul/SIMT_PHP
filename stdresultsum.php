...
echo "<label><h2>3RD SEMESTER EXAMINATION, 2013</h3></label>";
echo "</div>";

 
?>
<div style='width:120px;float:right;border:1px solid #333;padding:5px;margin:2px;' ><a href='rptstdresultsummery.php?page=1&deptid=<?php echo $deptid; ?>&semester=<?php echo $semester; ?>&stdadsem=<?php echo $stdadsem; ?>&session=<?php echo $session; ?>&year=<?php echo $year; ?>&heldmonths=<?php echo $heldmonths; ?>&show=all'>PRINT VIEW</a></div>
<br/>
<br/>
<br/>
<div class="mainWRAP">
