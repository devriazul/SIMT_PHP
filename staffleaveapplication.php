...
$().ready(function() {
	$("#searchid").autocomplete("search_empid.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<script language="javascript">
 $(document).ready(function(){
   $('#sbt').click(function(){
	...
	$.post('staffleaveapplication_search.php',arr,function(result){
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['t'])==1){ if(isset($msg)){ echo "<span style='color:#00CC00; font-weight:bold;'>$msg</span>";} ?><?php } if(isset($_GET['t'])==0){ if(isset($msg)){ echo "<span style='color:#FF9900; font-weight:bold;'>$msg</span>"; } } ?></font></p>
 <div class="search-background1">
	...
	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
           ...
           <tr>
             <td width="31%" class="style11"><div align="right">Enter Employee ID :</div></td>
             <td width="28%"><input name="searchid" type="text" id="searchid" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)"  size="29" placeholder="Search by employee ID" /></td>
