...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		<div id="shwrec" style="width:500px; margin:0 auto;"></div>
          <div align="center"><span style="font-weight:bold; font-size:14px; text-decoration:underline; ">Employee/ Faculty Provident Fund Opening Balance Entry</span><br />
          <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
			...
			<?php
			$j=0;
			$idata=$myDb->select("SELECT * FROM  `tbl_accchart` WHERE parentid =  '1042' and pftrace<>'1' order by accname");
			while($idataf=$myDb->get_row($idata,'MYSQL_ASSOC'))
			{ $j++;
			?>
					<form id="form1" name="form1" method="post" action="ins_providentfund_ob.php" enctype="multipart/form-data" >

            <tr>
              <td width="9%" class="style16 gridTblValue"><?php echo $j;?></td>
              <td width="48%" class="style16 gridTblValue"><?php echo $idataf['accname'];?><input name="accno[]" type="hidden" id="accno" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF; width:50px;" value="<?php echo $idataf['id'];?>" /><input name="accname[]" type="hidden" id="accname" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF; width:50px;" value="<?php echo $idataf['accname'];?>" /></td>
              <td width="31%" height="20" class="style16 gridTblValue"><div align="center">
                <input name="rcvamount[]" type="text" id="rcvamount" style="text-align:center; font-family: Verdana; font-size: 10pt; border: 1px solid #3399FF; width:150px;" onkeypress="return handleEnter(this, event)" />
