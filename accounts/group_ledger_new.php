...
$().ready(function() {
	$("#accno").autocomplete("search_accgroup.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input1">
		   <form id="sfrm" method="post" autocomplete="off" action="Report/ledger_group_sample_rpt.php" target="new">
			 <label><input type="text" name="accno" id="accno" align="left" style="text-align:left; width:150px;" placeholder="like current asset"></label>
