...
{ 
  	if($_SESSION['userid'])
	{
		$chka="SELECT*FROM  tbl_accdtl WHERE flname='manage_acc_group_head.php' AND userid='$_SESSION[userid]'";
...
<script language="javascript">
 $(document).ready(function(){
   ...
   $('input[name="B1"]').click(function(){
	...
	$.post("ins_acc_group_head.php",arr,function(r){
	  $('#accname').val('');
	  $('#shwrec').html(r);
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		...
		<form id="form1" name="form1" method="post">
          ...
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="2" id="stdtbl">
            <tr>
              <td height="30" colspan="3" class="style2" style="border-bottom:1px solid #999999; ">GROUP HEAD</td>
              </tr>
            <tr>
              <td class="style2">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="80%" height="20"><div align="left">
                <input name="accname" type="text" id="accname" placeholder="Enter account head name" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="40" />
              </div></td>
            </tr>
            <tr>
              <td class="style2">Group</td>
              <td height="20" class="style2">:</td>
              <td height="20"><input name="searchgroup" type="text" id="searchgroup" placeholder="search account head group" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="40" /></td>
            </tr>
            <tr>
              <td class="style2">Parent</td>
              <td height="20" class="style2">:</td>
              <td height="20"><input name="searchparent" type="text" id="searchparent" placeholder="search account head parent" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="40" /></td>
            </tr>
