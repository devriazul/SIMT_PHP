...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='GeneralJournalReport.php' AND userid='$_SESSION[userid]'";
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input1">
		   <form id="sfrm" method="post" autocomplete="off" action="Report/rptGeneralJournal.php" target="new">
