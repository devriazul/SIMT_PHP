...
$().ready(function() {
	$("#searchid").autocomplete("search_accheadnew.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
				...
				$('#searchid').keyup(function(){
				  ...
				  $.post("acchead_pagination.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
				});         
            });
...
<body>
<div style="position:fixed; top:0; left:0; width:100%; height:100%; background-color:#000; opacity:.9; display:none; " class="accpopup">
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
		   <div class="input">
		   <form method="post" name="frmsrch" id="frmsrch" autocomplete="off" action="add_acc_head.php">
