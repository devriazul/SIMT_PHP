...
<table width="900" border="0" align="center" cellpadding="3" cellspacing="0" class="style5" style="padding:3px; ">
  ...
  <tr>
    <td height="23" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <?php 
	  $rcvtotal=0;
	  $rtq=$myDb->select("SELECT*from tbl_accchart where (parentid=0 or parentid!=0) and (groupname=0 or groupname!=0) 
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <?php $pbtotal=0;
	   		$rtq=$myDb->select("SELECT *from tbl_accchart where (parentid=0 or parentid!=0) and (groupname=0 or groupname!=0)  order by accname asc"); 
	  		while($rtqf=$myDb->get_row($rtq,'MYSQL_ASSOC')){
	  ?>
