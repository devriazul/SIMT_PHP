...
<body>
		...
		$ts1=mysql_query("select * from tbl_2ndjournal where accno='".$_SESSION['getacc']."'") or die(mysql_error());
...
<table width="70%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td width="8%">&nbsp;</td>
		...
		$tspq=mysql_query("select * from tbl_accchart 
						 where id='".$tsf['parentid']."'") or die(mysql_error());
		$tspqf=mysql_fetch_array($tspq);
  ...
  <script language="javascript">
   $(document).ready(function(){
	 ...
	 $('.cls<?php echo $count; ?>').click(function(){
	   ...
	   window.location.href = "ledger_std_group_rpt.php?stgroup=<?php echo $tspqf['accname']; ?>&accno=<?php echo $_SESSION['getacc']; ?>&fdate=<?php echo $_SESSION['fdate']; ?>&tdate=<?php echo $_SESSION['tdate']; ?>";
	 });
