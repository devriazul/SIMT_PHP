...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='ledger_report.php' AND userid='$_SESSION[userid]'";
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2">
  ...
  <?php } ?>
		...
		<div id="top-search-div"> 
           <div id="content">
		   <div class="input1">
		   <form id="sfrm" method="post" autocomplete="off" action="Report/view_ledger_consulate.php" target="new">
			 <label><input type="text" name="accno" id="accno" align="left" style="text-align:left; width:150px;" placeholder="Account Name"  ></label>
