...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		<div id="shwrec" style="width:500px; margin:0 auto;"></div>
          <div align="center"><span style="font-weight:bold; font-size:14px; text-decoration:underline; ">Employee/ Faculty Security Money Receivable Entry</span><br />
          <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" id="stdtbl">
			...
			<?php
			$j=0;
			$idata=$myDb->select("SELECT * FROM  `tbl_accchart` WHERE parentid =  '1043' and srtrace<>'1' order by accname");
			while($idataf=$myDb->get_row($idata,'MYSQL_ASSOC'))
			{ $j++;
			?>
					<form id="form1" name="form1" method="post" action="ins_securitymoney_rcvlb.php" enctype="multipart/form-data" >
