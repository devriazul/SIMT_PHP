    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblleft">
      ...
      <tr>
        <td width="21%" valign="top" background="images/leftbg.jpg"><?php include("left.php");?><br />
		  ...
		  <div class="appset" style="width:500px;margin:0 auto;" align="center">
            <form name="form1" id="form1" method="post" action="" >
			  ...
			  <select name="drcrtype" id="drcrtype">
				...
				<option selected value="<?php echo @$_SESSION['drcrtype']; ?>">
				  <?php if(@$_SESSION['drcrtype']=="sdmcscmd"){ echo "Single/Multi"; 
				...
				<option value="sdmcscmd">Single/Multi</option>
				<option value="mcmd">Multi</option>
			  </select>
			  <br/>
			&nbsp;&nbsp;&nbsp;&nbsp; Transaction Mode:  
