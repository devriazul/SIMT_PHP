...
<?php 
         switch($_POST['listb']){
		   case 'department':
				  $sdq="SELECT b.bookid as id,d.name as 'Department Name',b.deptid,c.coursename 'Course Name',b.author Author,b.edition Edition,b.selfid 'Book Self No',b.rowno 'Row No' 
