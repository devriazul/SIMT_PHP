...
<table width="1047" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblleft">
      ...
      <tr>
        <td width="21%" valign="top" background="images/leftbg.jpg"><?php include("left.php");?>�
		  ...
		  <div style="width:200px;padding-left:10px;float:left;border-bottom:1px solid #999999;padding-top:10px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; height:30px; background-color:#CCCCCC; "><a href="#bdialog" name="bmodal">Manage Bookself</a></div>
          <div style="margin-top:50px;"></div>
		  <div style="width:200px;padding-left:10px;float:left;border-bottom:1px solid #999999;padding-top:10px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; height:30px; background-color:#CCCCCC; ">Library Record</div>
          <div style="margin-top:10px;"></div>
		  <div id="Lset">
		  <table width="400" cellpadding="0" cellspacing="0" style=" font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; ">
		   <tr>
		    <th>ID</td>
			<th>Max Allow</td>
			<th>Fine</td>
  ...
  <div style="padding-top:10px;padding-left:30px;">		  
          <div style="margin-top:50px;"></div>
		  <div style=" font-family:Verdana, Arial, Helvetica, sans-serif; font-size:13px; border-bottom:1px solid #999999; height:30px; background-color:#CCCCCC;padding-top:10px; padding-left:4px; ">Bookself Record</div>
          <div style="margin-top:10px;"></div>
		  <table width="700" cellpadding="0" cellspacing="0" id="book_rec">
		   <tr>
		    <th align="left" style="padding-left:3px; ">Department Name</td>
			<th>Self No</td>
			<th>Capacity</td>
