...
$(function () { var rid=$('#rid').val();
	...
	$('#issuee<?php echo $_GET['rowid']; ?>').dateEntry({spinnerImage: 'img/spinnerDefault.png'});
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<select name="deptid1" id="deptid1<?php echo $_GET['rowid']; ?>" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">
  ...
  <tr>
    ...
    <td><select name="semesterid" id="semesterid<?php echo $_GET['rowid']; ?>" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;" disabled>
  ...
  <tr>
    ...
    <td>
	<input type="date" name="issue" id="issuee1<?php echo $_GET['rowid']; ?>" size="30" value="<?php echo date("Y-m-d"); ?>" onkeypress="return handleEnter(this, event)" min="<?php echo date("Y-m-d"); ?>">
