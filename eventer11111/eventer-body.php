	   ...
	   <div align="center"><table width="1266" background="../images/1.jpg" border="0" cellspacing="0" cellpadding="0" >
          <tr>
                        ...
                        $dateBoxHTML .= '<div class="date-box-events-wrapper">';
                            $dateBoxHTML .= '<ul class="date-box-events">';
                                ...
                                while ($eventerEventRow = mysql_fetch_assoc($eventer_recset)) {
                                    $dateBoxHTML .= '<li class="events-list-item" id="date-box-event-'.$smsDateIterator.'-'.$eventerEventIterator++.'"><a href="#">'.$eventerEventRow['title'].'<p></p>Start Time:'.$eventerEventRow['start_time'].'->End Time:'.$eventerEventRow['end_time'].'<p></p>Venue:'.$eventerEventRow['venue'].'</a></li>';
                                }
