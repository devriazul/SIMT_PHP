...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?php }else{ ?>
		<td width="10%"><div class="bckcontent"><div align="right"><span class="clockStyle"><a href="schedulehome.php"><span class="top">Home</span></a>| <a href="logout.php"><span class="top">Logout </span></a></span></div></div></td>
	<?php } ?>
