...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
		<form name="MyForm" autocomplete="off" action="add_payscale.php" method="post" onsubmit="xmlhttpPost('ins_payscale.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
          <table width="70%" border="0" align="center" cellpadding="0" cellspacing="5" id="stdtbl">
            ...
            <tr>
              ...
              <td height="20"><input name="name" type="text" id="name" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="20"><input name="basicsalary" type="text" id="basicsalary" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" value="0" size="29" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">House Rent :<span class="stars">*</span> </td>
              <td height="20"><input name="houserent" type="text" id="houserent" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" value="0" size="29" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">Medical Allowance :<span class="stars">*</span> </td>
              <td height="20"><input name="medicalallow" type="text" id="medicalallow" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" value="0" size="29" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">Transport Allowance :<span class="stars">*</span> </td>
              <td height="20"><input name="transportallow" type="text" id="transportallow" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" value="0" size="29" /></td>
            </tr>
            <tr>
              <td width="31%" height="20" class="style2">Other Allowance :<span class="stars">*</span> </td>
              <td width="69%" height="20"><input name="otherallow" type="text" id="otherallow" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" value="0" size="29" /></td>
            </tr>
            <tr>
              <td height="20" class="style2">Remarks:</td>
              <td height="20"><textarea name="remarks" cols="60" id="remarks" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)"></textarea></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
