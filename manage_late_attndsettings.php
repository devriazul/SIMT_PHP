...
$(document).ready(function() {	
	...
	$('a[name=modal]').click(function(e) {
		...
		var maskWidth = $(window).width();
			    $('#table_wrapper').load('edit_late_attndsettings.php?id='+tid);
...
<div id="top-search-div"> 
           <div id="content">
		   <label>Manage Late Attendance </label>
		   Settings<br />
            ...
            <tr>
              <td><table width="100%" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="gridTbl">
                <tr bgcolor="#B7E8FF">
                  ...
                  <td width="18%" class="gridTblHead"><span class="style16 style12 style12">Section</span></td>
                  <td width="15%" class="gridTblHead"><span class="style16 style12 style12">Total no. of Days</span></td>
                  <td width="14%" class="gridTblHead"><span class="style16 style12 style12">Equal Absent Days</span></td>
                  <td width="13%" class="gridTblHead"><span class="style16 style12 style12">Action </span></td>
                </tr>
                <?php $show="SELECT * From tbl_late_attnd_setting";
                ...
                <tr>
                  ...
                  <td style="padding-left:40px;" class="gridTblValue"><span class="style16"><?php echo $dt['section']; ?></span></td>
                  <td style="padding-left:40px;" class="gridTblValue"><span class="style16"><?php echo $dt['nod']; ?></span></td>
                  <td style="padding-left:40px;" class="gridTblValue"><span class="style16"><?php echo $dt['ed']; ?></span></td>
