        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
                    ...
                    ({
                        type: "GET",
                        url: "studentid_paginationdPrev.php",
                        data: "page="+page,
					  //  data:$("form").serialize(),
				...
				$('#searchid').keyup(function(){
				  ...
				  $.post("studentid_paginationdPrev.php?page=1",arr,function(r){
				    $('#container').html(r);
				  });
				}); 
...
<div id="top-search-div"> 
           <div id="content">
		   <label>Manage Allocate Hostel </label>
		   <div class="input">
		   <form method="post" id="frmsrch" name="frmsrch" autocomplete="off" action="managedeallocatehostel1.php">
