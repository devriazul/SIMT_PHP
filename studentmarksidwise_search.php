...
<form name="MyForm" action="rptstudentallresults.php" id="frm" autocomplete="off"  method="post"  target="_blank">           
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="2" id="stdtbl">
             <tr>
               <td height="20" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">Individual Student Result Report </td>
             </tr>
             <tr>
             ...
             <tr>
               <td width="47%" height="20" class="style2"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="stdtbl">
				  ...
				  <tr bgcolor="#DFF4FF">
                   <td width="371" height="25" class="style2">Course Name </td>
                   <td width="43" height="25" class="style2"><div align="center">TM</div></td>
                   <td width="28" height="25" class="style2"><div align="center">CT</div></td>
                   <td width="27" class="style2"><div align="center">QT</div></td>
				   <td width="31" class="style2"><div align="center">JE</div></td>
				   <td width="31" class="style2"><div align="center">HW</div></td>
				   <td width="33" class="style2"><div align="center">JER</div></td>
				   <td width="37" class="style2"><div align="center">JEV</div></td>
				   <td width="37" class="style2"><div align="center">BHV</div></td>
				   <td width="36" class="style2"><div align="center">ATC</div></td>
				   <td width="36" class="style2"><div align="center">APC</div></td>
				   <td width="34" class="style2"><div align="center">JEF</div></td>
				   <td width="46" class="style2"><div align="center">JERF</div></td>
				   <td width="44" class="style2"><div align="center">JEVF</div></td>
				   <td width="39" class="style2"><div align="center">TF</div></td>
				   <td width="82" class="style2"><div align="center">TOM</div></td>
				   <td width="78" class="style2"><div align="center">Grade</div></td>
				  </tr>					
				<?php
			      if(isset($_POST['deptid']) && isset($_POST['session']) && isset($_POST['semester'])){
  				  $crs="SELECT mf.courseid, c.coursecode, c.coursename FROM tbl_courses c, tbl_marksentryfinal mf WHERE c.id= mf.courseid and mf.deptid='$_POST[deptid]' and mf.stdid= '$_POST[stdid]' and mf.semesterid='$_POST[semester]' and mf.session='$_POST[session]' and mf.year='$_POST[year]'";// and examtype='$_POST[examtype]'";
                 ...
                 <tr bgcolor="<?php echo $bgcolor; ?>"><?php 
				  $std="SELECT distinct m.stdid, m.examname, m.session, m.deptid, m.courseid, m.year, m.semesterid, (c.cont_assess_t+c.f_exam_t+c.cont_assess_p+c.f_exam_p) as TotalMarks,
						(select classtestmarks from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]'  and stdid='$_POST[stdid]') as ClassTest,
						(select quiztestmarks from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as QuizTest ,
						(select `hwmarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as HomeWork,
						(select `jobexpr` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperiment,
						(select `jobexprfinal` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperimentFinal,
						(select `jobexprreport` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperimentReport,
						(select `jobexprreportfinal` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperimentReportFinal,
						(select `jobexprviva` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperimentViva,
						(select `jobexprvivafinal` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as JobExperimentVivaFinal,
						(select `attendancemarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as AttendanceT,
						(select `attendancemarksprac` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as AttendanceP,
						(select `behaviormarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as Behavior,
						(select `finalexamprac` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as FinalExamPrac,
						(select `finalexammarks` from tbl_marksentryfinal WHERE deptid='$_POST[deptid]' and courseid= '$crsr[courseid]' and semesterid='$_POST[semester]' and session='$_POST[session]' and year='$_POST[year]' and stdid='$_POST[stdid]') as FinalExam 
				  ...
				  $stdr=$myDb->get_row($stdq,'MYSQL_ASSOC'); ?>
                   	...
                   	<td height="25" class="style4"><?php echo $crsr['coursename']." (". $crsr['coursecode'] .")";?>
               	   <input type="hidden" value="<?php echo $stdr['stdid']; ?>" name="stdid" id="stdid" /><input type="hidden" value="<?php echo $stdr['session']; ?>" name="session" id="sessionnew" /><input type="hidden" value="<?php echo $stdr['deptid']; ?>" name="deptid" id="deptid" /><input type="hidden" value="<?php echo $stdr['courseid']; ?>" name="courseid" id="courseid" /><input type="hidden" value="<?php echo $stdr['year']; ?>" name="eyear" id="eyear" /><input type="hidden" value="<?php echo $stdr['semesterid']; ?>" name="semesterid" id="semesterid" /></td>
                   	<td height="25" class="style4" ><div align="center"><input type="label" value="<?php echo $stdr['TotalMarks']; ?>" name="tm" id="tm<?php echo $count; ?>" style="width:30px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" /></div></td>
				...
				<?php 
				  ...
				  $stdr=$myDb->get_row($stdq,'MYSQL_ASSOC'); ?>
                   	<td height="25" class="style4"><?php echo $crsr['coursename']." (". $crsr['coursecode'] .")";?><input type="hidden" value="<?php echo $stdr['stdid']; ?>" name="stdid" id="stdid" /><input type="hidden" value="<?php echo $stdr['session']; ?>" name="session" id="sessionnew" /><input type="hidden" value="<?php echo $stdr['deptid']; ?>" name="deptid" id="deptid" /><input type="hidden" value="<?php echo $stdr['courseid']; ?>" name="courseid" id="courseid" /><input type="hidden" value="<?php echo $stdr['year']; ?>" name="eyear" id="eyear" /><input type="hidden" value="<?php echo $stdr['semesterid']; ?>" name="semesterid" id="semesterid" /></td>
                   	<td height="25" class="style4" ><div align="center"><input type="label" value="<?php echo $stdr['TotalMarks']; ?>" name="tm" id="tm<?php echo $count; ?>" style="width:30px; font-weight:bold; text-align:center;" onKeyPress="return handleEnter(this, event);" disabled="disabled" /></div></td>
