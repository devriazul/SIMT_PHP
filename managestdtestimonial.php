        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
                    ...
                    ({
                        type: "GET",
                        url: "stdtestimonial_pagination.php",
                        data: "page="+page,
					  //  data:$("form").serialize(),
				...
				$('#searchid').keyup(function(){
				  var frmarr=$('#frmsrch').serializeArray();
				  $.post("stdtestimonial_pagination.php?page=1",frmarr,function(r){
						$("#container").html(r);				  
...
<div id="top-search-div"> 
		   ...
		   <div class="input">
		   <form method="post" id="frmsrch" name="frmsrch" autocomplete="off" action="managestdtestimonial1.php">
		     <label>Search By</label>
			 <label><input type="text" id="searchid" name="searchid" placeholder="Student Board Roll No" /></label>
