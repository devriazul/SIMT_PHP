...
$q = $_GET["p"];
if (!$q) return;
$sql = "select sid 'id',name from tbl_staffinfo where tbl_staffinfo.name like '$q%' union select facultyid 'id',name from tbl_faculty where tbl_faculty.name like '$q%'";
$rsd = mysql_query($sql);
?>
