...
<form name="sfrm" id="sfrm" method="post">
  ...
  <tr>
    <td colspan="3" style="border-bottom:1px solid #333333; background-color:#CCCCCC; height:30px;">Add Requesition <div id="req"><label>Requisition ID:</label><label><input type="text" id="reqid" name="reqid" onkeypress="return handleEnter(this, event)" value="" /><input type="button" id="greq" name="greq" value="Generate Requisition ID" ></label></div> </td>
  </tr>
  ...
  <tr>
    ...
    <td><label>
      <input type="button" name="submit" id="submit" value="Submit" />
           ...
           <div id="showpick" style="width:500px; height:500px; height:auto;margin-top:-260px;float:right;"></div>
