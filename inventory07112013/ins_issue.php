...
{ 
  ...
  if($cpr>=$qty){
  if($myDb->insert_sql("INSERT INTO tbl_issue(empid,pid,iqty,issue_date,storeid)VALUES('$empid','$pid','$qty','$issuedate','$storeid')")){
?>
<style type="text/css">
<!--
...
<?php 							   
     echo "<div style='width:400px; height:20px; padding:5px;background-color:#F7F7F7; color:#333333; border-bottom:1px solid #333333'>Product issue successfull</div>";
  }else{
