...
<?php 
     $sdq="SELECT id,pname 'Product Name',packsize 'Pack Size',qty 'OB Qty', prtype 'Product Type' FROM tbl_product order by id desc LIMIT $start, $per_page";
...
<?php 
 /* --------------------------------------------- */
 $msg='';
$query_pag_num = "SELECT COUNT(*) AS count FROM tbl_product";
