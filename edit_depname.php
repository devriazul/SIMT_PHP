...
<div id="top-search-div"> 
		...
		<br />
			<form name="MyForm" id="MyForm" autocomplete="off" action="edit_depname.php?id=<?php echo $id; ?>" method="post" onsubmit="xmlhttpPost('ed_depname.php?id=<?php echo $id; ?>', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          <div align="center"><br />
...
<td height="20" colspan="2" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">DEPARTMENT INFORMATION </td>
            ...
            <tr>
              ...
              <td width="23%" height="20"><input name="code" type="text" id="code" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $egr['code']; ?>" /></td>
              <td colspan="2"><span class="style2">Name:</span><span class="stars">*</span>                
                <input name="name" type="text" id="name" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="50" value="<?php echo $egr['name']; ?>" /></td>
              </tr>
            <tr>
			...
			<tr>
              ...
              <td height="20"><input name="admform" type="text" id="admform" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $egr['admform']; ?>" /></td>
              <td height="20"><span class="style2">Receive Book :<span class="stars">*</span></span></td>
              <td height="20"><input name="rcvbook" type="text" id="rcvbook" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" value="<?php echo $egr['rcvbook']; ?>" /></td>
            </tr>
            <tr>
